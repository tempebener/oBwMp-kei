        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-active">
              ...
              <li class="active"><a href="<?php echo base_url().'admin/slider'?>"><i class="fa fa-picture-o"></i> List Slider </a></li>
            </ul>
          </li>
          <li class="treeview">
            <a>
                ...
                <table id="example1" class="table table-striped" style="font-size:13px;">
                  ...
                  <tr>
                    ...
                    <td style="text-align:right;">
                          <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $id_slider;?>"><span class="fa fa-pencil"></span></a>
                          <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $id_slider;?>"><span class="fa fa-trash"></span></a>
                    </td>
                  </tr>
          <?php endforeach;?>
                  </tbody>
