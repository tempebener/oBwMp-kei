...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url() ?>assets/images/logojoglo.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?php echo base_url() ?>assets/images/logojoglo.png" width="60" height="60" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-small-cap">FRONTEND</li>                        
                        
                            <li>
                                <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-arrange-send-backward"></i><span class="hide-menu">Frontend</span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <!-- <li>
                                        <a class="has-arrow" href="#" aria-expanded="false">Slider</span></a>
                                        <ul aria-expanded="false" class="collapse">
                                            <li><a href="<?php echo base_url('slider') ?>"><i ></i> All Slider</a>
                                            </li>            
                                            <?php if ($this->session->userdata('role') == 'admin'): ?>
                                                <li><a href="<?php echo base_url('admin/slider') ?>"><i ></i> Add Slider</a></li>
                                            ...
                                            <?php if ($this->session->userdata('role') == 'admin'): ?>
                                                <li><a href="<?php echo base_url('admin/slider') ?>"><i ></i> Slider</a></li>
        ...
        <!-- ==========================Dynamicaly Show Main Page Content============================ -->
            ...
            <footer class="footer">
                © 2021 KESATRIAAN ENTREPRENEUR INDONESIA
            </footer>
