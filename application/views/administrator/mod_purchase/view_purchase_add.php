...
$kode_pembelian = "PO-".sprintf("%06s", $kode->id_pembelian+1);
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/add_purchase',$attributes);
          ...
          echo "<div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='150px' scope='row'>No. PO</th>    <td><input type='text' style='width:40%; display:inline-block' class='form-control' id='pembelian' name='a' value='$a' readonly='on'>
                                                                                <label generated='true' class='error' id='message'></label></td></tr>
                    <tr><th width='150px' scope='row'>Order Date</th>    <td><input type='text' id='datepickerr' class='form-control' name='g' value='$g' readonly='on' required></td></tr>

                    <tr><th scope='row'>Supplier</th>    <td><select name='d' class='combobox form-control' required>
                                                             ...
                                                             echo "</select></td></tr>
                    <tr class='hidden'><th scope='row'>Type bayar</th>    <td><select name='e' class='form-control'>";
                ...
                <div class='col-md-6'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th scope='row'>Send Date</th>    <td><input type='text' id='datepicker' class='form-control' name='b' value='$b' required></td></tr>
                    ...
                    <tr><th scope='row'>Send Location</th>    <td><select name='i' class='form-control'>";
                                                                foreach ($lokasi as $rows){
                                                                  if ($e == $rows['id_lok']){
                                                                    echo "<option value='$rows[id_lok]' selected>$rows[nama_lok]</option>";
                                                                  }else{
                                                                    echo "<option value='$rows[id_lok]'>$rows[nama_lok]</option>";
                                                                  }
                                                                }
                                                             echo "
                    <tr><th scope='row'>Information</th>    <td><textarea class='form-control' name='f' style='height:60px'>$f</textarea></td></tr>
                  </tbody>
                  </table>
                </div>
                      ...
                      <tbody>";
                        ...
                        foreach ($penyesuaian_detail->result_array() as $r){
                          echo "<tr>
                                ...
                                <td>0</td>
                                <td>$r[jml_pesan]</td>
                                <td align=center><a href='".base_url()."administrator/delete_purchase_detail/$r[id_pembelian_detail]' class='text-danger'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a></td>
                              </tr>";
                          $no++;
                        }
