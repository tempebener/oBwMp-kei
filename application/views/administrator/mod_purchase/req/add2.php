    ...
    border:1px solid #e3e3e3;
...
</style> <?php echo form_open_multipart('administrator/save_purchase_req');?>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>ADD Purchase Req</h3>
                </div>
              <div class='box-body'><div class='col-md-6'>
                  ...
                  <tbody id="t1">
                    ...
                    <tr><th width='150px' scope='row'>Req No</th>    <td><input type='text' style='width:40%; display:inline-block' class='form-control' id='pembelian' name='a' value='' readonly='on'>
                                                                                <label generated='true' class='error' id='message'></label></td></tr>
                    <tr><th width='150px' scope='row'>Req Date</th>    <td><input type='text'  class='form-control' name='g' value='<?php echo date("Y-m-d");?>' readonly='on' required></td></tr>
                ...
                <div class='col-md-6'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Send Location</th>    <td><select name='e' class='combobox form-control' >
...
<tbody id="tx">
                        <tr>
                          <td class="tnomor"></td>
                          <td><select name='aa[]' id='a'  class='aa comboboxx form-control' onchange=\"changeValue(this.value)\"  autofocus>
                          ...
                          <td><input class='form-control' id='b' type='tanggal' name='bb[]'></td>
                          <td><input class='form-control' id='c' type='number' name='cc[]'></td>
                          <td><input class='dd form-control' type='text'  name='dd[]' id='satuan' readonly='on'> </td>
                            <td><input class='form-control' id='e' type='text' name='ee[]'></td>
