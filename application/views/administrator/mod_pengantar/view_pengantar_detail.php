<section class='invoice'>
  ...
  <div class='row'>
    <div class='col-xs-12'>
      ...
      <?php foreach ($pengantar as $row){
        echo "<a class='btn btn-success btn-sm' title='Edit Data' href='".base_url()."admin/administrator/edit_pengantar/$row[id_pengantar]'>Edit</a>"; 
        } 
      ?>
    </div>
    <!-- /.col -->
    ...
    <div class='col-xs-12 table-responsive'>
      <table class='table table-striped'>
        ...
        foreach ($pengantar as $row){
          ...
          <tr><th>Deskripsi | Kiri</th><td> $row[deskripsi1]</td></tr>
          ...
          <tr><th>Deskripsi | Tengah</th><td> $row[deskripsi2]</td></tr>
          ...
          <tr><th>Deskripsi | Kanan</th><td> $row[deskripsi3]</td></tr>";
        $no++;
        } 
      ?>
      </table>
