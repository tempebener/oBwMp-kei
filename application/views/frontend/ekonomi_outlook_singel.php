        ...
        <div class="container">
          ...
          <div class="breadcrumb">
            <div class="breadcrumb-inner">
              ...
              <div class="breadcrumb-item"><span class="breadcrumb-text breadcrumb-active"><?php echo "$rows[judul_eo]"; ?></span></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="text-block text-block-1">
            <div class="row">
              ...
              <div class="col-md-8">
                  <img class="image-custom rounded" src="<?php echo base_url();?>theme/images/foto_ekonomi/<?php echo "$rows[foto_eo]"; ?>" alt="naget ayam" width="100%" height="auto" style="float:left;">
          ...
          <div class="post">
           <!--  <div class="post-meta">
            ...
            <div class="post-title h6"><?php echo "$rows[judul_eo]"; ?></div>
            </br>
            <div class="post-text">
                ...
                <div class="col-6 col-sm-3 col-md-6">
                  ...
                  <article class="blurb blurb-side">
                    ...
                    <div class="blurb-item">
                      ...
                      <img class="image-custom rounded" src="<?php echo base_url();?>theme/images/foto_ekonomi/ekonomi_detail/<?php echo $post_new->gambar ?>" alt="Jaminan Akses Pemodalan" width="80px" height="auto">
                    </div>
                    <div class="blurb-body">
                      <div class="blurb-counter-value h2"><!-- <span data-counter="">100</span><span class="counter-postfix">%</span> -->
                      </div>
                      
                      <div class="blurb-title h4"><a href="#"><?php echo $post_new->judul_eo_detail ?></a></div>
