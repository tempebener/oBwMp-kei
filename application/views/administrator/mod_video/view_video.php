    ...
    <div class="box-body table-responsive padding">
      ...
      <?php
        ...
        foreach ($record as $row){
          if ($row['gbr_video'] == ''){ $foto ='blank.png'; }else{ $foto = $row['gbr_video']; }
        echo "<tr><td>$no</td>
                  <td>$row[jdl_video]</td>

                  <td>$row[youtube]</td>
                  <td><center><img style='border:1px solid #cecece' width='150px'  src='".base_url()."asset/foto_video/$foto'></center></td>
