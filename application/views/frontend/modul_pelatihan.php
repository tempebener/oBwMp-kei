              ...
              ?>
                  <div class="price-box">
                    ...
                    <div class="price-box-body">
                      <div class="price-box-title h6"><a href="<?php echo base_url("detail/$post_new->id_pelatihan/$post_new->judul_pelatihan_seo ") ?>" class="margin-auto"><?php echo $post_new->judul_pelatihan ?></a></div>
