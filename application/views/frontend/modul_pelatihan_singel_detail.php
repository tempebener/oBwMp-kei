            ...
            <div class="col-md-6 col-xl-4">
              <div class="box box-info">
                ...
                <div class="box-list">
                  ...
                  <div class="box-list-item">
                    <div class="box-list-term">
                      <?php if(empty($rows->download_pdf)) {echo "";}
                                              else { echo "
                                                <a href='".base_url()."theme/images/foto_pelatihan/pelatihan_detail/".$rows->download_pdf."' >Download Modul</a>
