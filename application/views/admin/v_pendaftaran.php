      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-active">
              
              <li class="active" ><a href="<?php echo base_url().'admin/pendaftaran'?>"><i class="fa fa-picture-o"></i> List member </a></li>
            </ul>
          </li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       ...
                       $member_nama=$i['nama'];
                       $member_alamat=$i['alamat'];
                       $member_hp=$i['no_hp'];
                       $member_email=$i['email'];
                       $member_pendidikan=$i['pend_terakhir'];
                       $member_pekerjaan=$i['pekerjaan'];
                       $member_usaha=$i['usaha_diminati'];
                       $member_ktp=$i['foto_ktp'];
                       $member_npwp=$i['foto_npwp'];
                       $member_pas=$i['foto_pas'];
                ...
                <tr>
                  ...
                  <td><?php echo $member_alamat;?></td>
                  <td><?php echo $member_hp;?></td>
                   <td><?php echo $member_email;?></td>
                   <td><?php echo $member_pendidikan;?></td>
                   <td><?php echo $member_pekerjaan;?></td>
                   <td><?php echo $member_usaha;?></td>
                   <td><img src="<?php echo base_url().'theme/images/foto_member/ktp/'.$member_ktp;?>" style="width:80px;"></td>
                   <td><img src="<?php echo base_url().'theme/images/foto_member/npwp/'.$member_npwp;?>" style="width:80px;"></td>
                   <td><img src="<?php echo base_url().'theme/images/foto_member/profil/'.$member_pas;?>" style="width:80px;"></td>
                </tr>
        <?php endforeach;?>
                </tbody>
              </table>
...
<!-- ./wrapper -->
  ...
  <?php foreach ($data->result_array() as $i) :
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id_slider;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $id_slider;?>"/>
  ...
  <!--Modal Hapus Pengguna-->
        <div class="modal fade" id="ModalHapus<?php echo $id_slider;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <div class="modal-body">
                     <input type="hidden" name="kode" value="<?php echo $id_slider;?>"/>
                     <input type="hidden" value="<?php echo $slider_gambar;?>" name="gambar">
                     <!-- <input type="hidden" value="<?php echo $slider_album_id;?>" name="album"> -->
