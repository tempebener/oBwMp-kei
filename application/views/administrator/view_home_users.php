          ...
          <div class='box'>
            ...
            <div class='box-body'>
              ...
              <div class='alert alert-success alert-dismissible'>
                ...
                Diharapkan informasi akun sesuai dengan identitas pada Kartu Pengenal anda, Untuk Mengubah informasi Profile anda klik <a href='".base_url()."administrator/edit_manajemenuser/".$this->session->id_users."'>disini</a>.
              </div></div>
          </div>
        </div>
