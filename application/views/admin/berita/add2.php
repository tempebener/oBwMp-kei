    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add New berita</li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Add New berita <a href="<?php echo base_url('admin/berita/all_berita_list') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i> All berita </a></h4>

                </div>
                <div class="card-body">
                    
                    <form action="<?php echo base_url().'admin/berita/add'?>" method="post" enctype="multipart/form-data">
                        <div class="form-body">
                            <br>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="controls">
                                            <button type="submit" value="submit" class="btn btn-success">Save user</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
