...
<body>
    ...
    <section id="wrapper">
        ...
        <div class="login-register" style="background-image:url(<?php echo base_url() ?>theme/images/foto_slider/bc_login.JPG);width: 100%;height:100%">     
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('auth/log'); ?>" method="post">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="email" name="user_name" required="" placeholder="Nama Pengguna(EMAIL)"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
