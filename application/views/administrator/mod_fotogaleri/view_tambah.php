<div class="col-md-12">
              ...
              <div class="box-body"><?php echo form_open_multipart('admin/administrator/fotogaleri_simpan'); ?>
              <div class="col-md-12">
                  <table class="table table-condensed table-bordered">
                  <tbody>
                    <tr><th width="120px" scope="row">Judul</th>    <td><input type="text" class="form-control" name="judul_fotogaleri" required></td></tr>
