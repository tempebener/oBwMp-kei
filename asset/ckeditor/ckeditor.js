...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                basePath: function() {
                    ...
                    if (!b)
                        for (var c = document.getElementsByTagName("script"), d = 0; d < c.length; d++) { var l = c[d].src.match(a); if (l) { b = l[1]; break } } - 1 == b.indexOf(":/") && "//" != b.slice(0, 2) && (b = 0 === b.indexOf("/") ? location.href.match(/^.*?:\/\/[^\/]*/)[0] +
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        ...
                        if (1 == c.length)
                            ...
                            b = !1;
                            try { b = !window.frameElement } catch (r) {} document.documentElement.doScroll && b && d()
                        }
                    }
                }()
            },
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, g, h, l) {
                function m(a, f, C, l) { a = { name: b, sender: this, editor: a, data: f, listenerData: h, stop: C, cancel: l, removeListener: r }; return !1 === d.call(g, a) ? !1 : a.data }

                function r() { C.removeListener(b, d) } var f = a.call(this, b); if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    g || (g = this);
                    isNaN(l) && (l = 10); var C = this;
                    m.fn = d;
                    m.priority = l; for (var u = f.length - 1; 0 <= u; u--)
                        if (f[u].priority <= l) return f.splice(u + 1, 0, m), { removeListener: r };
                    f.unshift(m) } return { removeListener: r } },
            ...
            removeListener: function(a, b) { var g = d(this)[a]; if (g) { var h = g.getListenerIndex(b);
    ...
    (function() {
        var a = [],
            ...
            m = function(a, f) { return "#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : l[f] };
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) { var f = arguments.length,
                    b, c; "boolean" == typeof(b = arguments[f - 1]) ? f-- : "boolean" == typeof(b = arguments[f - 2]) && (c = arguments[f - 1], f -= 2); for (var l = 1; l < f; l++) { var d = arguments[l],
                        q; for (q in d)
                        if (!0 === b || null == a[q])
            ...
            isEmpty: function(a) { for (var f in a)
                    if (a.hasOwnProperty(f)) return !1; return !0 },
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) { var d = /\n{2}/g; if (d.test(c)) var q = "\x3c" + l + "\x3e",
                        m = "\x3c/" + l + "\x3e",
                        c = q + c.replace(d, function() { return m + q }) + m } c = c.replace(/\n/g, "\x3cbr\x3e");
                b || (c = c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + l + "\x3e)"), function(a) { return CKEDITOR.tools.repeat(a, 2) }));
            ...
            createClass: function(a) {
                ...
                if (c) var d = f,
                    f = function() { var a = this._ || (this._ = {}),
                            f; for (f in c) { var b = c[f];
                            a[f] = "function" == typeof b ? CKEDITOR.tools.bind(b, this) : b } d.apply(this, arguments) };
            ...
            tryThese: function() { for (var a, f = 0, b = arguments.length; f < b; f++) { var c = arguments[f]; try { a = c(); break } catch (l) {} } return a },
            ...
            normalizeCssText: function(a, f) { var b = [],
                    c, l = CKEDITOR.tools.parseCssText(a, !0, f); for (c in l) b.push(c + ":" + l[c]);
            ...
            normalizeHex: function(a) { return a.replace(/#(([0-9a-f]{3}){1,2})($|;|\s+)/gi, function(a, b, c, l) { a = b.toLowerCase();
                    3 == a.length && (a = a.split(""), a = [a[0], a[0], a[1], a[1], a[2], a[2]].join("")); return "#" + a + l }) },
            ...
            writeCssText: function(a, b) { var c, l = []; for (c in a) l.push(c + ":" + a[c]);
                b && l.sort(); return l.join("; ") },
            objectCompare: function(a, b, c) { var l; if (!a && !b) return !0; if (!a || !b) return !1; for (l in a)
                    if (a[l] != b[l]) return !1; if (!c)
                    for (l in b)
                        if (a[l] != b[l]) return !1; return !0 },
            ...
            eventsBuffer: function(a, b, c) {
                function l() { m = (new Date).getTime();
                    d = !1;
                    c ? b.call(c) : b() } var d, m = 0; return { input: function() { if (!d) { var b = (new Date).getTime() - m;
            ...
            checkIfAnyArrayItemMatches: function(a, b) { for (var c = 0, l = a.length; c < l; ++c)
                    if (a[c].match(b)) return !0; return !1 },
            checkIfAnyObjectPropertyMatches: function(a, b) { for (var c in a)
                    if (c.match(b)) return !0; return !1 },
                ...
                parse: {
                    ...
                    margin: function(a) {
                        function b(a) { c.top = l[a[0]];
                            ...
                            c.bottom = l[a[2]];
                            c.left = l[a[3]] } var c = {},
                            l = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"]; switch (l.length) {
                            case 1:
                                b([0, 0, 0, 0]); break;
                            case 2:
                                b([0, 1, 0, 1]); break;
            ...
            array: { filter: function(a, b, c) { var l = [];
                    this.forEach(a, function(d, m) { b.call(c, d, m, a) && l.push(d) }); return l }, forEach: function(a, b, c) { var l = a.length,
                        d; for (d = 0; d < l; d++) b.call(c, a[d], d, a) } }
        };
    ...
    CKEDITOR.dtd = function() {
        var a = CKEDITOR.tools.extend,
            d = function(a, b) { for (var c = CKEDITOR.tools.clone(a), l = 1; l < arguments.length; l++) { b = arguments[l]; for (var d in b) delete c[d] } return c },
            b = {},
            c = {},
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getPreviousSourceNode: function(a, d, b) {
            if (b && !b.call) { var c = b;
                b = function(a) { return !a.equals(c) } } a = !a && this.getLast && this.getLast();
            var e;
        ...
        getCommonAncestor: function(a) { if (a.equals(this)) return this; if (a.contains && a.contains(this)) return a; var d = this.contains ? this : this.getParent();
            do
                if (d.contains(a)) return d; while (d = d.getParent()); return null },
        ...
        rtrim: function() {
            for (var a; this.getLast && (a = this.getLast());) { if (a.type == CKEDITOR.NODE_TEXT) { var d = CKEDITOR.tools.rtrim(a.getText()),
                    ...
                    else { a.remove(); continue } } break } CKEDITOR.env.needsBrFiller &&
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getByAddress: function(a, d) {
            for (var b =
                    ...
                    for (var g = -1, h = 0; h < b.childNodes.length; h++) { var l = b.childNodes[h]; if (!0 !== d || 3 != l.nodeType || !l.previousSibling || 3 != l.previousSibling.nodeType)
                            if (g++, g == e) { b = l; break } } else b = b.childNodes[e] }
    ...
    (function() {
        ...
        function c(a) { for (var b = 0, c = 0, f = h[a].length; c < f; c++) b += parseInt(this.getComputedStyle(h[a][c]) || 0, 10) || 0; return b }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            breakParent: function(a, b) {
                ...
                if (CKEDITOR.env.ie && !CKEDITOR.env.edge) { for (c = new CKEDITOR.dom.element("div"); d = f.getFirst();) d.$.style.backgroundColor && (d.$.style.backgroundColor = d.$.style.backgroundColor), c.append(d);
                    c.insertAfter(this);
            ...
            mergeSiblings: function() {
                function a(b, c, f) {
                    if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b.isIdentical(c)) { for (var l = f ? b.getLast() : b.getFirst(); d.length;) d.shift().move(b, !f);
                            c.moveChildren(b, !f);
                            c.remove();
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                        8 !== CKEDITOR.env.version : 1)) { var e = this.$.getBoundingClientRect(),
                        g = f.$.documentElement,
                    ...
                    for (q = this, x = null; q && "body" != q.getName() &&
                        ...
                        q.equals(this) || (b += q.$.clientLeft || 0, c += q.$.clientTop || 0); for (; x && !x.equals(q);) b -= x.$.scrollLeft, c -= x.$.scrollTop, x = x.getParent();
                        x = q;
                        q = (e = q.$.offsetParent) ? new CKEDITOR.dom.element(e) : null } a && (e = this.getWindow(), q = a.getWindow(), !e.equals(q) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function q(a, b) { var c = { x: 0, y: 0 }; if (!a.is(h ? "body" : "html")) { var f = a.$.getBoundingClientRect();
                        c.x = f.left;
                        c.y = f.top } f = a.getWindow();
                    f.equals(b) || (f = q(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y); return c }
            ...
            getEditor: function(a) { var b = CKEDITOR.instances,
                ...
                a = a || void 0 === a; for (c in b)
                    if (f = b[c], f.element.equals(this) && f.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || !a && (d = f.editable()) && (d.equals(this) || d.contains(this))) return f; return null },
            find: function(a) {
                var c = d(this);
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) { var B = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    h = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
                this._.guardRTL = function(a, b) { return (!b || !B.equals(a)) && (!h || !a.equals(h)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) } }
            var L = a ? this._.guardRTL : this._.guardLTR;
            g = k ? function(a, b) { return !1 === L(a, b) ? !1 : k(a, b) } : L;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
            ...
            m = function(a) { return h(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
        CKEDITOR.dom.walker.ignored =
            function(a) { return function(b) { b = g(b) || h(b) || l(b); return !!(a ^ b) } };
        ...
        CKEDITOR.dom.walker.empty = function(a) { return function(b) { for (var c = 0, f = b.getChildCount(); c < f; ++c)
                    if (!r(b.getChild(c))) return !!a; return !a } };
        var f = CKEDITOR.dom.walker.empty(),
            C = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function(a) { var b = {},
        ...
        CKEDITOR.dom.element.prototype.getBogus = function() { var a = this;
            do a = a.getPreviousSourceNode(); while (m(a)); return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && e.test(a.getText())) ? a : !1 }
    })();
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function q(a, b, c, f) { var d = c ? a.getPrevious() : a.getNext(); if (f && l) return d;
                k || f ? b.append(a.clone(!0, e), c) : (a.remove(), r && b.append(a)); return d }

            function g() { var a, b, c, f = Math.min(P.length, v.length); for (a = 0; a < f; a++)
                    if (b = P[a], c = v[a], !b.equals(c)) return a; return a - 1 }
            ...
            if (k && n.type == CKEDITOR.NODE_TEXT && p.equals(n)) p = a.document.createText(p.substring(t, z)), c.append(p);
                ...
                for (var P = p.getParents(), v = n.getParents(), G = g(), D = P.length - 1, I = v.length - 1, K = c, M, Z, X, fa = -1, S = G; S <= D; S++) {
                    Z =
                        P[S];
                    X = Z.getNext();
                    for (S != D || Z.equals(v[S]) && D < I ? b && (M = K.append(Z.clone(0, e))) : B ? q(Z, K, !1, L) : m && K.append(a.document.createText(Z.substring(t))); X;) { if (X.equals(v[S])) { fa = S; break } X = q(X, K) } K = M
                }
                K = c;
                for (S = G; S <= I; S++)
                    if (c = v[S], X = c.getPrevious(), c.equals(P[S])) b && (K = K.getChild(0));
                    else { S != I || c.equals(P[S]) && I < D ? b && (M = K.append(c.clone(0, e))) : F ? q(c, K, !1, H) : Q && K.append(a.document.createText(c.substring(0, z))); if (S > fa)
                            for (; X;) X = q(X, K, !0);
                        K = M } k || h()
            }
        }
        ...
        function e(a) {
            return function() {
                var b;
                return this[a ?
                    "getPreviousNode" : "getNextNode"](function(a) {!b && r(a) && (b = a); return m(a) && !(h(a) && a.equals(b)) })
            }
        }
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                function a(b) {
                    ...
                    if (f.type == CKEDITOR.NODE_ELEMENT && 0 < d) { a: { for (e = f; d--;)
                                if (g = e.getChild(d).getIndex(!0), 0 <= g) { d = g; break a } d = -1 } d += 1 }
                    if (f.type == CKEDITOR.NODE_TEXT) { e = f; for (g = 0;
                        ...
                        e = g;
                        f.getText() ? d += e : (g = f.getPrevious(c), e ? (d = e, f = g ? g.getNext() : f.getParent().getFirst()) : (f = f.getParent(), d = g ? g.getIndex(!0) + 1 : 0)) } b.container = f;
                    b.offset = d
                }
            ...
            trim: function(a, b) {
                ...
                if ((!a ||
                        ...
                        if (d >= c.getLength()) d = c.getIndex() + 1, c = c.getParent();
                                ...
                                d = c.getIndex() + 1,
                                c = c.getParent();
                            this.startContainer.equals(this.endContainer) ? this.setEnd(q, this.endOffset - this.startOffset) : c.equals(this.endContainer) && (this.endOffset += 1) } else d = c.getIndex(), c = c.getParent();
                    this.setStart(c, d); if (e) { this.collapse(!0); return } } c = this.endContainer;
                d = this.endOffset;
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var q = function(a, b) {
                            ...
                            for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; f =
                                ...
                                B = f != a ? f.getText() : f.substring(b); if (d.test(B)) return !1 }
                            return !0
                        };
                                        ...
                                        if (t && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(B)) p = null;
                                                ...
                                                for (var F = p.$.getElementsByTagName("*"), L = 0, H; H =
                                                    F[L++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[H.nodeName.toLowerCase()]) { p = null; break } p && (z = !!B.length)
                                        } else p = null;
                                    z && (t ? n ? l = k : k && this.setStartBefore(k) : t = !0);
                                    if (p) { z = p.getPrevious(); if (!k && !z) { k = p;
                                            p = null; break } p = z } else k = null
                                } k && (k = c(k.getParent()))
                        }
                        z = this.endContainer;
                        F = this.endOffset;
                        ...
                        for (; k ||
                            p;) {
                            if (k && !p) {!n && k.equals(g) && (n = !0); if (e ? k.isBlockBoundary() : !h.contains(k)) break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, Q, P = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            v = null,
                            G = function(a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (v) { if (v.equals(a)) { v = null; return } } else v = a;
                                else if (v) return; var b = P(a);
                                b || (m = a); return b },
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { k = this.clone();
                            k = new CKEDITOR.dom.walker(k); var D = CKEDITOR.dom.walker.whitespaces(),
                                I = CKEDITOR.dom.walker.bookmark();
                            k.evaluator = function(a) { return !D(a) && !I(a) }; if ((k = k.previous()) && k.type == CKEDITOR.NODE_ELEMENT && k.is("br")) break } k = this.clone();
                        k.collapse();
            ...
            moveToElementEditablePosition: function(a, b) {
                ...
                for (var c = 0; a;) {
                    ...
                    else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block)) return this.setStartBefore(a), this.setEndAfter(a),
                        !0;
                    var d = a,
                        e = c,
                        q = void 0;
    ...
    (function() {
        ...
        function b(a, c, e, g) {
            a: { null == g && (g = d(e)); for (var h; h = g.shift();)
                    if (h.getDtd().p) { g = { element: h, remaining: g }; break a } g = null }
            if (!g) return 0;
                ...
                for (this._.nextNode = null; x;) {
                    ...
                    if (E) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (E = 0);
                        ...
                        if (CKEDITOR.dtd.$block[p] && "false" == x.getAttribute("contenteditable")) { d = x;
                            b(this, a, d); break } else if (x.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { if ("br" == p) E = 1;
                            else if (!h && !x.getChildCount() && "hr" != p) { d = x;
                                u = x.equals(q); break } h && (h.setEndAt(x, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = x));
                            J = 1 } else { if (x.getFirst()) { h || (h = this.range.clone(), h.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
                                x = x.getFirst(); continue } E = 1 }
                    }
                    E && !h && (h = this.range.clone(), h.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
                    u = (!J || E) && x.equals(q);
                    if (h && !J)
                        for (; !x.getNext(l) && !u;) { p = x.getParent(); if (p.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { J = 1;
                                E = 0;
                                u || p.equals(q);
                                h.setEndAt(p, CKEDITOR.POSITION_BEFORE_END); break } x = p;
                            E = 1;
                            u = x.equals(q);
                            k = 1 } E && h.setEndAt(x, CKEDITOR.POSITION_AFTER_END);
    ...
    (function() {
        function a(a, b, c, d, k) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (t in P) { f = P[t];
                    g = n[f];
                    D = [];
                    v = void 0; for (v in g) - 1 < v.indexOf("*") ? D.push(new RegExp("^" + v.replace(/\*/g, ".*") + "$")) : D.push(v);
                    g = D;
                    g.length && (n[f] = g, q = !1) } n.nothingRequired = q;
        ...
        function c(a, b, c) { if (!a.match || a.match(b)) { if (a.noProperties) return !1;
                ...
                a = a.classes;
                b = b.classes; if (a) { for (var d = !1, k = !0 === a, p = b.length; p--;)
        ...
        function e(a,
            b) { if (!a) return !1; var c = !1,
                d = !0 === a,
                k; for (k in b)
                if (d || a(k)) delete b[k], c = !0; return c }

        function g(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1;
            a._.cachedChecks = {}; return !0 }

        function h(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = H(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {},
                d = 0,
                k; for (k in a) c[k] = a[k], d++; return d ? c : !1 }
        ...
        function l(a, b) {
            ...
            if (k = a.requiredClasses)
                for (e = b.classes, c = 0; c < k.length; ++c)
                    if (d = k[c], "string" == typeof d) { if (-1 == CKEDITOR.tools.indexOf(e, d)) return !1 } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(e, d)) return !1;
        ...
        function f(a) { var b, c, d, k, e = {},
                p = 1; for (a = H(a); b = a.match(v);)(c = b[2]) ? (d = C(c, "styles"), k = C(c, "attrs"), c = C(c, "classes")) : d = k = c = null, e["$" + p++] = { elements: b[1], classes: c, styles: d, attributes: k }, a = a.slice(b[0].length); return e }

        function C(a, b) { var c = a.match(G[b]); return c ? H(c[1]) : null }
        ...
        function A(a, b, k, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) { a: { f = a.elementCallbacks; for (var t = 0, g = f.length, v; t < g; ++t)
                        if (v = f[t](b)) { f = v; break a } f = void 0 } if (f) return f }
            if (e.doTransform && (f = a._.transformations[b.name])) { u(b); for (t = 0; t < f.length; ++t) p(a, b, f[t]);
                q(b) }
            if (e.doFilter) {
                a: {
                    ...
                    if (a || f) { u(b); if (t)
                            for (z = 0, B = t.length; z < B; ++z)
                                if (!1 === c(t[z], b, h)) { a = null; break a } if (g)
                            for (z = 0, B = g.length; z < B; ++z) c(g[z], b, h); if (a)
                            for (z = 0, B = a.length; z < B; ++z) d(a[z], b, h, v); if (f)
                            for (z = 0, B = f.length; z < B; ++z) d(f[z], b, h, v);
                        a = h } else a = null
                }
                if (!a || !a.valid) return k.push(b),
                1;B = a.validAttributes;
                var l = a.validStyles;
                f = a.validClasses;
                var t = b.attributes,
                    L = b.styles,
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (G in L) a.allStyles || l[G] ? m.push(G + ":" + L[G]) : z = !0;
                    m.length && (t.style = m.sort().join("; ")) } else K && (t.style = K);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (G = 0; G < g.length; ++G)(a.allClasses || f[g[G]]) && h.push(g[G]);
                    h.length && (t["class"] = h.sort().join(" "));
                    v && h.length < v.split(/\s+/).length && (z = !0) } else v && (t["class"] = v);z && (n = 1);
                if (!e.skipFinalValidation && !x(b)) return k.push(b),
                1
            }
        ...
        function z(a) { return function(b) { return n(b, a) } }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (k = 0; k < b.length; ++k) e = this.allow(b[k], c, d); return e } a(this, b, c, this.allowedContent, this._.allowedRules);
                return !0
            },
            ...
            addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
                        k; for (b = 0; b < a.length && !k; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (k = c); if (k) { for (b = 0; b < a.length; ++b) d.push(t(a[b], k));
        ...
        K = CKEDITOR.filter.transformationsTools = {
            ...
            lengthToStyle: function(a, b, c) { c = c || b; if (!(c in a.styles)) { var d = a.attributes[b];
                    d && (/^\d+$/.test(d) && (d += "px"), a.styles[c] = d) } delete a.attributes[b] },
            ...
            splitBorderShorthand: function(a) {
                ...
                if (a.styles.border) {
                    ...
                    switch (c.length) {
                        case 1:
                            a.styles["border-width"] = c[0]; break;
                        case 2:
                            b([0, 1, 0, 1]); break;
                        case 3:
                            b([0, 1, 2, 1]); break;
                        case 4:
                            b([0, 1, 2, 3]) } a.styles["border-style"] = a.styles["border-style"] || (a.styles.border.match(/(none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset|initial|inherit)/) || [])[0];
    ...
    CKEDITOR.scriptLoader = function() {
        ...
        return {
            load: function(b, c, e, g) {
                ...
                if (0 === l) f(!0);
                    ...
                    var C = function(a, b) {
                        ...
                        u = function(b, c) { a[b] = 1; var e = d[b];
                            delete d[b]; for (var f = 0; f < e.length; f++) e[f](b, c) },
                        A = function(b) {
                            if (a[b]) C(b, !0);
                            else {
                                var e = d[b] || (d[b] = []);
            ...
            queue: function() {
                function a() { var b;
                    (b = c[0]) && this.load(b.scriptUrl, b.callback, CKEDITOR, 0) } var c = []; return function(d, g) { var h = this;
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + h[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)
                    for (var g = h[a[f]], q = 0; q < g.length; q++) { var x = g[q];
                        l[x] = this.get(x);
                        c[x] = 1 } d.call(b, l) }, this)
        }
    };
            ...
            var g = {},
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        var b = [],
                            f;
                        for (f in a) { var l = a[f],
                                u = l && l.requires; if (!d[f]) { if (l.icons)
                        ...
                        if (b.length) h.call(this,
                            b);
                        else { for (f in g) l = g[f], l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete g[f], l.onLoad._called = 1);
                            c && c.call(e || window, g) }
                    }, this)
                };
            h.call(this, b)
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++A; while (CKEDITOR.instances[a]); return a }
        ...
        function g(a, b, c) { if (b) { var d, e, k = a.commands; for (e in k) d = k[e], (c || d.contextSensitive) && d.refresh(a, b) } }
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                CKEDITOR.scriptLoader.load(e, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++)
                        for (var p =
                                0; p < d.length; p++) { var n = d[p];
                            0 === e && k[p] && n.lang && n.langEntries && (a.lang[n.name] = n.langEntries[k[p]]); if (n[c[e]]) n[c[e]](a) } a.fireOnce("pluginsLoaded");
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            getSelectedHtml: function(a) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, e, k, p, n = 0; n < c.length; n++) { var f = c[n],
                        g = f.startContainer;
                    g.getName && "tr" == g.getName() ? (e || (e = g.getAscendant("table").clone(), e.append(g.getAscendant("tbody").clone()), d.append(e), e = e.findOne("tbody")), k && k.equals(g) || (k = g, p = g.clone(), e.append(p)), p.append(f.cloneContents())) : d.append(f.cloneContents()) } b = e ? d : b.getHtmlFromRange(c[0]);
            ...
            getCommandKeystroke: function(a) { var b = a.name,
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, e, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (e = c[1])
                        if (e = e.toLowerCase(), h && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(h.join("")), h = null), !h) { this.onTagClose(e); continue } if (h) h.push(c[0]);
                    else if (e = c[3]) { if (e = e.toLowerCase(), !/="/.test(e)) { var l = {},
                                m, r = c[4];
                            c = !!c[5]; if (r)
                                for (; m = a.exec(r);) { var f = m[1].toLowerCase();
                                    m = m[2] || m[3] || m[4] || "";
                                    l[f] = !m && d[f] ? f : CKEDITOR.tools.htmlDecodeAttr(m) } this.onTagOpen(e, l, c);!h && CKEDITOR.dtd.$cdata[e] && (h = []) } } else if (e = c[2]) this.onComment(e)
                }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, h, l) {
                function m(a) { var b; if (0 < x.length)
                        for (var c = 0; c < x.length; c++) { var d = x[c],
                                k = d.name,
                                e = CKEDITOR.dtd[k],
                ...
                function r() { for (; J.length;) C(J.shift(), w) }
                ...
                function C(b, c, d) { c = c || w || q; var e = w;
                ...
                y.onTagOpen = function(e, n, f, g) {
                    ...
                    if (a(n)) x.push(n);
                        ...
                        if ("pre" == e) k = !0;
                        else { if ("br" == e && k) { w.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (E = !0) }
                        if ("br" == e) J.push(n);
                        else {
                ...
                y.onTagClose = function(a) {
                    for (var b = x.length - 1; 0 <= b; b--)
                        if (a == x[b].name) { x.splice(b, 1); return } for (var c = [], d = [], k = w; k != q && k.name != a;) k._.isBlockLike || d.unshift(k), c.push(k), k = k.returnPoint || k.parent;
                    if (k != q) {
                ...
                y.onText = function(a) { if (!(w._.hasInlineStarted && !J.length || k || E) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = w.name,
                        f = b ? CKEDITOR.dtd[b] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!E && !f["#"] && b in d) y.onTagOpen(e[b] || ""), y.onText(a);
                    else { r();
                        m();
                        k || E || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a); if (u(w, a)) this.onTagOpen(l, {}, 0, 1);
                        w.add(a) } };
                y.onCDATA =
    ...
    (function() {
        ...
        function d(b, c, d, g) { var h, l; for (h in c)(l = b[h]) || (l = b[h] = new a), l.add(c[h], d, g) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onElement: function(a, c) { for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], g, h = 0; 3 > h; h++)
                        if (g = d[h]) { g = g.exec(a, c, this); if (!1 === g) return null; if (g && g != c) return this.onNode(a, g); if (c.parent && !c.name) break } return c },
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, d) { for (var g = [this.findIndex(c), 0], h = 0, l = a.length; h < l; h++) g.push({ value: a[h], priority: c, options: d });
            ...
            exec: function(a, c) {
                ...
                for (C = 0; C < l; C++)
                    if (d && (m = c.type, r = c.name), f = h[C], !(a.nonEditable && !f.options.applyToAll ||
                            a.nestedEditable && f.options.excludeNestedEditable)) { f = f.value.apply(null, g); if (!1 === f || d && f && (f.name != r || f.type != m)) return f;
                        null != f && (g[0] = c = f) } return c
            },
    ...
    (function() {
        ...
        function h(a, b) { var c = a.children[a.children.length - 1];
            a.children.push(b);
            b.parent = a;
        ...
        function r(a) {
            return a.replace(B,
                function(a, b, c) { return "\x3c" + b + c.replace(F, function(a, b) { return L.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        }
        ...
        function C(a) { return a.replace(Q, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function q(a, b) {
            ...
            a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function(a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function(a, b) { k[k.id] = decodeURIComponent(b); return "{cke_protected_" + k.id++ + "}" }) });
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, k) { return "\x3c" + c + d + "\x3e" + y(A(k), b) + "\x3c/" + c + "\x3e" })
        }
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            ...
            toDataFormat: function(a, b) { var c, d, k;
                b && (c = b.context, d = b.filter, k = b.enterMode);
                c || null === c || (c = this.editor.editable().getName()); return this.editor.fire("toDataFormat", { dataValue: a, filter: d || this.editor.filter, context: c, enterMode: k || this.editor.enterMode }).dataValue }
        };
        var x = /(?:&nbsp;|\xa0)$/,
            J = "{cke_protected}",
            w = CKEDITOR.dtd,
            ...
            t = { elements: { embed: function(a) { var b = a.parent; if (b && "object" == b.name) { var c = b.attributes.width,
            ...
            z = {
                ...
                elements: {
                    $: function(a) { var b = a.attributes; if (b) { if (b["data-cke-temp"]) return !1; for (var c = ["name", "href", "src"], d, k = 0; k < c.length; k++) d = "data-cke-saved-" + c[k], d in b && delete b[c[k]] } return a },
                    table: function(a) {
        ...
        CKEDITOR.env.ie && (z.attributes.style = function(a) { return a.replace(/(^|;)([^\:]+)/g, function(a) { return a.toLowerCase() }) });
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) { h = d.name; if (!(l = a.onElementName(b, h))) return this.remove(), !1;
                    d.name = l; if (!(d = a.onElement(b, d))) return this.remove(), !1; if (d !== this) return this.replaceWith(d), !1; if (d.name == h) break; if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if (!d.name) return this.replaceWithChildren(), !1 } h = d.attributes;
                var m, r;
                for (m in h) {
                    for (l = h[m];;)
                    ...
                    else { delete h[m]; break } r && (!1 === (l = a.onAttribute(b, d, r, l)) ? delete h[r] :
                        h[r] = l)
                }
            ...
            writeHtml: function(a, b) { b && this.filter(b); var g = this.name,
                    ...
                    l = this.attributes,
                    m, r;
                a.openTag(g, l); for (m in l) h.push([m, l[m]]);
                a.sortAttributes && h.sort(d);
                m = 0; for (r = h.length; m < r; m++) l = h[m], a.attribute(l[0], l[1]);
            ...
            split: function(a) { for (var b = this.children.splice(a, this.children.length - a), d = this.clone(), h = 0; h < b.length; ++h) b[h].parent = d;
                d.children = b;
    ...
    (function() {
        ...
        CKEDITOR.replaceAll = function() { for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) { var d = null,
                    h = a[b]; if (h.name || h.id) { if ("string" == typeof arguments[0]) { if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(h.className)) continue } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](h, d))) continue;
                    this.replace(h, d) } } };
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, h) {
            ...
            h = h ? this.container.getFirst(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : l;
            h.setSize("width", a, !0);
            r && (r.style.width = "1%");
    ...
    (function() {
        function a(a) {
            ...
            h(b, e.block, f) && B.collapsed && !B.getCommonAncestor().isReadOnly() && (e = B.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function(a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
        ...
        function g(a) {
            function b(a) { return function(b, k) { k && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b); if (!(k || !c(b) || a && A(b))) return !1 } }
            var d, e = a.getRanges()[0];
            a = a.root;
            var f = { table: 1, ul: 1, ol: 1, dl: 1 };
            if (e.startPath().contains(f)) { var g = e.clone();
                g.collapse(1);
                g.setStartAt(a, CKEDITOR.POSITION_AFTER_START);
                a = new CKEDITOR.dom.walker(g);
                a.guard = b();
                a.checkBackward(); if (d) return g = e.clone(), g.collapse(), g.setEndAt(d, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(g), a.guard = b(!0), d = !1, a.checkForward(), d }
            return null
        }
        ...
        function l(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 }
            ...
            proto: {
                ...
                insertElement: function(a, b) {
                    ...
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a,
                        CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) { return c(a) && !A(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));
                    d.selectRanges([b]);
                    m(this)
                },
                ...
                fixInitialSelection: function() {
                    function a() { var b = c.getDocument().$,
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) k = !0;
                            else { if (CKEDITOR.env.webkit && (k = c.getDocument().getActive()) && k.equals(c) && !d.anchorNode) { k = !0; break a } k = void 0 } k && (k = new CKEDITOR.dom.range(c), k.moveToElementEditStart(c), b = b.createRange(), b.setStart(k.startContainer.$, k.startOffset), b.collapse(!0), d.removeAllRanges(), d.addRange(b)) }
                ...
                getHtmlFromRange: function(a) { if (a.collapsed) return new CKEDITOR.dom.documentFragment(a.document);
                    ...
                    w.eol.fix(a, this); return new CKEDITOR.dom.documentFragment(a.fragment.$) },
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
                                    ...
                                    g; if (d)
                                    for (; g = d.getItem(f++);)
                                        if (!C(g)) { d = !0; break a } d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), u(a.startContainer) && a.startContainer.appendBogus();
                ...
                setup: function() {
                    ...
                    if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) { var d = function() { var b = a.editable();
                        ...
                        this.on("scroll", d) } a.focusManager.add(this);
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (e && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(e, !c) && d.collapsed) {
                                        if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var f = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (f && f.type == CKEDITOR.NODE_ELEMENT && f.is("hr")) { a.fire("saveSnapshot");
                                                f.remove();
                                                b = !0; break a } } d = d.startPath().block;
        ...
        q = function() {
            ...
            return function(m, v, G, D) {
                ...
                if (!D.checkReadOnly()) {
                    ...
                    if (!v.collapsed) { var I = M.block || M.blockLimit,
                    ...
                    if (H = G) {
                        ...
                        if ("text" == m.type && m.inlineStylesRoot) { u = m.inlineStylesPeak;
                            v = u.getDocument().createText("{cke-peak}"); for (D = m.inlineStylesRoot.getParent(); !u.equals(D);) v = v.appendTo(u.clone()), u = u.getParent();
                            G = v.getOuterHtml().split("{cke-peak}").join(G) } u =
                            m.blockLimit.getName();
                        if (/^\s+|\s+$/.test(G) && "span" in CKEDITOR.dtd[u]) { var A = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            G = A + G + A } G = m.editor.dataProcessor.toHtml(G, { context: null, fixForBody: !1, protectedWhitespaces: !!A, dontFilter: m.dontFilter, filter: m.editor.activeFilter, enterMode: m.editor.activeEnterMode });
                    ...
                    if (H) {
                        ...
                        for (F(v, w); D < v.length; D++) {
                            ...
                            if (y) G = 0 < D;
                                ...
                                if ((y = w.startPath().block) && !y.equals(N)) { if (O = y.getBogus()) O.remove(), A.push(y);
                                    N = y } M.firstNotAllowed && (I = 1);
                                if (I && M.isElement) {
                                    y = w.startContainer;
                                    for (E = null; y && !q[y.getName()][M.name];) { if (y.equals(u)) { y = null; break } E = y;
                                        y = y.getParent() }
                                ...
                                if (Y) { for (; y = Y.pop();) w.insertNode(y);
                    ...
                    if (!m.dontMoveCaret) {
                        for (N = e(O); N && a(N) && !N.is(q.$empty);) {
                            ...
                            else { if (f(N) && N.getHtml().match(/(\s|&nbsp;)$/g)) { T = null; break } T = O.clone();
                                T.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END) } N = N.getLast(c)
                        }
                        T && O.moveToRange(T)
                    }
                }
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({
                        ...
                        g = function(a) { return !a.equals(h) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) { var l = e.contains(CKEDITOR.dtd.$list).getParent();
                        g = function(a) { return !a.equals(l) } } g || (g = function(a) { return !a.equals(e.block) && !a.equals(e.blockLimit) });
            ...
            return {
                list: {
                    ...
                    merge: function(a, c) { if (a.mergeListBookmark) { var d = a.mergeListBookmark.startNode,
                                ...
                                k = new CKEDITOR.dom.elementPath(e, c); if (a.mergeList) { var g = f.contains(CKEDITOR.dtd.$list),
                                    n = k.contains(CKEDITOR.dtd.$list);
                                g.equals(n) || (n.moveChildren(g), n.remove()) } a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem), k = k.contains(CKEDITOR.dtd.$listItem), f.equals(k) || b(k, d, e));
                            d.remove();
                            e.remove() } }
                },
                block: {
                ...
                table: function() {
                    function a(c) {
                        ...
                        k.guard = function(a, k) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) { var p = "visited_" + (k ? "out" : "in"); if (a.getCustomData(p)) return;
                    ...
                    return {
                        ...
                        deleteRanges: function(a) { for (var b; b = a.tableContentsRanges.pop();) b.extractContents(), u(b.startContainer) && b.startContainer.appendBogus();
    ...
    (function() {
        ...
        function g(a) { h(a, !1); var b = a.getDocument().createText(A);
        ...
        function l(a, b) { return b ? a.replace(y, function(a, b) { return b ? " " : "" }) : a.replace(A, "") }
                ...
                if (!c.collapsed) {
                    ...
                    d.evaluator = function(d) {
                        if (d.type == CKEDITOR.NODE_ELEMENT &&
                            ...
                            d.getPosition(h.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d), e.collapsed || a.splice(b + 1, 0, e)); return !0 }
                        return !1
                    };
                    d.next()
                }
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                function c() { k.removeListener("mouseup", c);
                    l.removeListener("mouseup", c); var a = CKEDITOR.document.$.selection,
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            l.on("mousedown", function(a) {
                                function b(a) { a = a.data.$; if (D) { var c = p.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) {} D.setEndPoint(0 > I.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        D.select() } }
                                ...
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { D = p.$.createTextRange(); try { D.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {} I = D.duplicate();
                                    l.on("mousemove", b);
                                    k.on("mouseup", c);
                                    l.on("mouseup", c) }
                            })
                ...
                g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() { e.forceNextSelectionCheck();
                    e.selectionChange(1) });
                if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var K;
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (a)
                ...
                else { try { e = a.createRange() } catch (f) {} d = e && CKEDITOR.dom.element.get(e.item && e.item(0) || e.parentElement()) } if (!d ||
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getType: C ? function() {
                ...
                return a.type = b
                    ...
                    c = this.getNative(); if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
                        ...
                        d = c.startContainer;
                    d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset - c.startOffset && E[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT) } return a.type = b },
            getRanges: function() {
                var a = C ? function() {
                    ...
                    return function() {
                        ...
                        if (d == CKEDITOR.SELECTION_TEXT) return a = new CKEDITOR.dom.range(this.root), d = b(c, !0), a.setStart(new CKEDITOR.dom.node(d.container), d.offset), d = b(c), a.setEnd(new CKEDITOR.dom.node(d.container), d.offset), a.endContainer.getPosition(a.startContainer) & CKEDITOR.POSITION_PRECEDING && a.endOffset <= a.startContainer.getIndex() &&
                            a.collapse(), [a];
                        if (d == CKEDITOR.SELECTION_ELEMENT) { for (var d = [], e = 0; e < c.length; e++) { for (var f = c.item(e), g = f.parentNode, k = 0, a = new CKEDITOR.dom.range(this.root); k < g.childNodes.length && g.childNodes[k] != f; k++);
            ...
            getSelectedElement: function() { var a = this._.cache; if (void 0 !== a.selectedElement) return a.selectedElement; var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && E[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ }); return a.selectedElement = c ? new CKEDITOR.dom.element(c) : null },
            ...
            reset: function() { this._.cache = {};
                this.isFake = 0; var a = this.root.editor; if (a && a._.fakeSelection)
                    if (this.rev == a._.fakeSelection.rev) { delete a._.fakeSelection; var b = a._.hiddenSelectionContainer; if (b) { var c = a.checkDirty();
                            a.fire("lockSnapshot");
                            b.remove();
                            a.fire("unlockSnapshot");!c && a.resetDirty() } delete a._.hiddenSelectionContainer } else CKEDITOR.warn("selection-fake-reset");
                this.rev = u++ },
                        ...
                        if (l) this.fake(l);
                            ...
                            if (C) {
                                ...
                                for (y = 0; y < a.length; y++) {
                                    ...
                                    try { u.setEnd(l.endContainer.$, l.endOffset) } catch (v) { if (0 <= v.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), u.setEnd(l.endContainer.$, l.endOffset);
                                        else throw v; } f.addRange(u)
                                }
                            }
                            this.reset();
            ...
            fake: function(a, b) { var c = this.root.editor;
                void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label"));
                this.reset();
                m(c, b); var d = this._.cache,
            ...
            selectBookmarks: function(a) {
                for (var b = [], c, d = 0; d < a.length; d++) { var e = new CKEDITOR.dom.range(this.root);
                    e.moveToBookmark(a[d]);
                    b.push(e) } a.isFake && (c = b[0].getEnclosedNode(), c && c.type ==
            ...
            removeAllRanges: function() { if (this.getType() != CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[C ? "empty" : "removeAllRanges"]() } catch (b) {} this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
        ...
        function b(c) {
            ...
            if (c.collapsed) f = J(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                var q = c.createBookmark(),
                    ...
                    u = p,
                    t;
                if (!h) { var w = c.getCommonAncestor(),
                        h = a(p, w),
                        w = a(r, w);
                ...
                for (u.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
                    ...
                    if (u.equals(r)) u = null, h = !0;
                        ...
                        if (A && u.data("cke-bookmark")) { u = u.getNextSourceNode(!0); continue }
                        if (w && m && CKEDITOR.dtd.$block[A])
                            for (var C = u, z = e(C), B = void 0, E = z.length, F = 0, C = E && new CKEDITOR.dom.range(C.getDocument()); F < E; ++F) { var B = z[F],
                                    L = CKEDITOR.filter.instances[B.data("cke-filter")]; if (L ? L.check(this) : 1) C.selectNodeContents(B), b.call(this, C) } z = A ? !n[A] || x ? 0 : w && !m ? 0 : d(u, r, k, Q) : 1;
                        if (z)
                            if (B = u.getParent(), z = k, E = g, F = l, !B || !(B.getDtd() || CKEDITOR.dtd.span)[E] && !F || z.parentRule && !z.parentRule(B)) h = !0;
                            else {
                                if (t ||
                                    A && CKEDITOR.dtd.$removeEmpty[A] && (u.getPosition(r) | Q) != Q || (t = c.clone(), t.setStartBefore(u)), A = u.type, A == CKEDITOR.NODE_TEXT || w || A == CKEDITOR.NODE_ELEMENT && !u.getChildCount()) { for (var A = u, R;
        ...
        function c(a) {
            function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break;
                    ...
                    n.checkElementRemovable(h, !0) && (f = h) } f && m.breakParent(f);
                e && d.breakParent(e) } a.enlarge(CKEDITOR.ENLARGE_INLINE, 1);
            var c =
                a.createBookmark(),
                d = c.startNode;
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0, h; g < e.elements.length && (h = e.elements[g]) && h != e.block && h != e.blockLimit; g++)
                    if (this.checkElementRemovable(h)) { var l;
                        a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (l = a.checkBoundaryOfElement(h, CKEDITOR.START))) ? (f = h, f.match = l ? "start" : "end") : (h.mergeSiblings(), h.is(this.element) ? A.call(this, h) : q(h, k(this)[h.getName()])) } if (f) {
                    h = d;
                    for (g = 0;; g++) {
                        l = e.elements[g];
                        if (l.equals(f)) break;
                    ...
                    n = this;
                b(); for (e = d; !e.equals(m);) f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? A.call(this, e) : q(e, k(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f } a.moveToBookmark(c);
        ...
        function l(a) { var b = a.createBookmark(!0),
                c = a.createIterator();
        ...
        function y(a) { for (var b = k(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0); for (var f in b)
                if (f != this.element)
        ...
        function w(a, b) { var c = b._.definition,
                d = c.attributes,
        ...
        function E(a,
            b) { for (var c in a) a[c] = a[c].replace(L, function(a, c) { return b[c] }) }

        function k(a) { if (a._.overrides) return a._.overrides; var b = a._.overrides = {},
        ...
        function n(a, b) {
            function c(a, b) { return "font-family" == b.toLowerCase() ? a.replace(/["']/g, "") : a } "string" == typeof a && (a = CKEDITOR.tools.parseCssText(a)); "string" == typeof b && (b = CKEDITOR.tools.parseCssText(b, !0)); for (var d in a)
                if (!(d in b) || c(b[d], d) != c(a[d], d) && "inherit" != a[d] && "inherit" != b[d]) return !1; return !0 }
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) { if (a instanceof CKEDITOR.dom.document) return t.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode;
            ...
            checkActive: function(a, b) { switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var c = a.elements, d = 0, e; d < c.length; d++)
                            if (e = c[d], this.type != CKEDITOR.STYLE_INLINE || e != a.block && e != a.blockLimit) { if (this.type == CKEDITOR.STYLE_OBJECT) { var f = e.getName(); if (!("string" == typeof this.element ? f == this.element : f in this.element)) continue } if (this.checkElementRemovable(e, !0, b)) return !0 } } return !1 },
            checkApplicable: function(a,
                b, c) { b && b instanceof CKEDITOR.filter && (c = b); if (c && !c.check(this)) return !1; switch (this.type) {
                    case CKEDITOR.STYLE_OBJECT:
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) { for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? n(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0
                }
                return !1
            },
        ...
        CKEDITOR.style.getStyleText = function(a) {
            ...
            for (var e in b) { var f = b[e],
                    g = (e + ":" + f).replace(F, ";"); "inherit" == f ? d += g : c += g } c.length && (c = CKEDITOR.tools.normalizeCssText(c, !0));
            return a._ST = c + d
        };
        ...
        CKEDITOR.dom.elementPath = function(b, e) {
            ...
            do
                if (m.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (m.equals(e)) break;
                    if (!h && (r = m.getName(),
                            "true" == m.getAttribute("contenteditable") ? h = m : !g && d[r] && (g = m), a[r])) { if (r = !g && "div" == r) { a: { r = m.getChildren(); for (var f = 0, C = r.count(); f < C; f++) { var u = r.getItem(f); if (u.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[u.getName()]) { r = !0; break a } } r = !1 } r = !r } r ? g = m : h = m }
                } while (m = m.getParent());
            h || (h = e);
            this.block = g;
            this.blockLimit = h;
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function(a) { var d = this.elements;
            a = a && a.elements; if (!a || d.length != a.length) return !1; for (var b = 0; b < d.length; b++)
                if (!d[b].equals(a[b])) return !1; return !0 },
    ...
    (function() {
        function a(a, c, d) { var g = a.serializable,
            ...
            c[d ? "endContainer" : "startContainer"] = h; return c }
    ...
    (function() {
        ...
        function d(b) { var c = CKEDITOR.skin["ua_" + b],
                ...
                for (var c = c.split(",").sort(function(a, b) { return a > b ? -1 : 1 }), e = 0, g; e < c.length; e++)
                    if (g = c[e], d.ie && (g.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == g) && (g = "ie"), d[g]) { b += "_" + c[e]; break } return CKEDITOR.getUrl(a() + b + ".css") }
    ...
    (function() {
        if (CKEDITOR.env.webkit) CKEDITOR.env.hc = !1;
            ...
            a.appendTo(CKEDITOR.document.getHead()); try { var d = a.getComputedStyle("border-top-color"),
                ...
                CKEDITOR.env.hc = !(!d || d != b) } catch (c) { CKEDITOR.env.hc = !1 } a.remove() } CKEDITOR.env.hc && (CKEDITOR.env.cssClass += " cke_hc");
    ...
    */
        ...
        onLoad: function() {
            ...
            CKEDITOR.ui.dialog.textInput.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {
                ...
                setValue: function(b) { if (this.bidi) { var a = b && b.charAt(0);
                        ...
                        this.setDirectionMarker(a) } b || (b = ""); return CKEDITOR.ui.dialog.uiElement.prototype.setValue.apply(this, arguments) },
            ...
            CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                ...
                getValue: function() { for (var b = this._.children, a = 0; a < b.length; a++)
                        if (b[a].getElement().$.checked) return b[a].getValue(); return null },
                accessKeyUp: function() { var b = this._.children,
                        a; for (a = 0; a < b.length; a++)
                        if (b[a].getElement().$.checked) { b[a].getElement().focus(); return } b[0].getElement().focus() },
                eventProcessors: {
                    onChange: function(b, a) {
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, q, {
                ...
                registerEvents: function(b) { var a = /^on([A-Z]\w+)/,
                        ...
                        c; for (c in b)
                        if (d = c.match(a)) this.eventProcessors[c] ? this.eventProcessors[c].call(this, this._.dialog, b[c]) : f(this, this._.dialog, d[1].toLowerCase(), b[c]); return this },
                reset: function() {
                    function b() {
                        d.$.open();
                        var b = "";
    ...
    (function() {
        ...
        function Y(a) {
            ...
            a.parts.title.on("mousedown", function(g) {
                ...
                if (CKEDITOR.env.ie6Compat) { var f = u.getChild(0).getFrameDocument();
                    f.on("mousemove", b);
                    f.on("mouseup", c) } g.data.preventDefault()
            }, a)
        }
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            if (!("removeDialogTabs" in a._) && a.config.removeDialogTabs) { h = a.config.removeDialogTabs.split(";"); for (m = 0; m < h.length; m++)
                    if (p = h[m].split(":"), 2 == p.length) { var r = p[0];
                        k[r] || (k[r] = []);
                        k[r].push(p[1]) } a._.removeDialogTabs = k }
            ...
            show: function() {
                ...
                for (var c in b.contents)
                    if (b.contents[c]) { var a = b.contents[c],
                            e = this._.tabs[a.id],
                            d = a.requiredContent,
                            f = 0; if (e) { for (var g in this._.contents[a.id]) { var h = this._.contents[a.id][g]; "hbox" != h.type && "vbox" != h.type && h.getInputElement() && (h.requiredContent && !this._.editor.activeFilter.check(h.requiredContent) ? h.disable() : (h.enable(), f++)) }!f || d && !this._.editor.activeFilter.check(d) ? e[0].addClass("cke_dialog_tab_disabled") : e[0].removeClass("cke_dialog_tab_disabled") } } CKEDITOR.tools.setTimeout(function() {
                    this.layout();
                    X(this);
        ...
        (function() {
            var a = { build: function(a, c, e) { for (var d = c.children, f, g = [], h = [], p = 0; p < d.length && (f = d[p]); p++) { var m = [];
                        g.push(m);
                        h.push(CKEDITOR.dialog._.uiElementBuilders[f.type].build(a, f, m)) } return new CKEDITOR.ui.dialog[c.type](a, h, g, e, c) } };
        ...
        (function() {
            ...
            CKEDITOR.on("instanceDestroyed", function(a) { if (CKEDITOR.tools.isEmpty(CKEDITOR.instances)) { for (var b; b = CKEDITOR.dialog._.currentTop;) b.hide(); for (var c in z) z[c].remove();
                    z = {} } a = a.editor._.storedDialogs; for (var d in a) a[d].destroy() })
        })();
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function(a, b) {
                ...
                else { if ("failed" == e) throw O(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.'); "string" == typeof e && CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(e), function() { "function" != typeof CKEDITOR.dialog._.dialogDefinitions[a] && (CKEDITOR.dialog._.dialogDefinitions[a] = "failed");
    ...
    (function() {
        ...
        function g() { for (var c, a = 0; a < arguments.length; a++)
                if (arguments[a] instanceof CKEDITOR.dom.element) { c = arguments[a]; break } if (c) { var a = this.att,
                    b = this.getValue();
    ...
    (function() {
            ...
            if (!a.isReadOnly() && !a.equals(d.editable())) {
                ...
                for (var c = d.editable();
                    ...
                    if (b.getCustomData("bidi_processed")) { a.removeStyle("direction");
                        a.removeAttribute("dir"); return } b = "useComputedState" in d.config ? d.config.useComputedState : 1;
        ...
        function v(a, f, d) { var b = a.getCommonAncestor(!1, !0);
            a = a.clone();
            ...
            return {
                ...
                refresh: function(a, d) {
                    var b = a.config.useComputedState,
                        c, b = void 0 === b || b;
                    if (!b) { c = d.lastElement; for (var h = a.editable(); c && !(c.getName() in u || c.equals(h));) { var e = c.getParent(); if (!e) break;
                        ...
                        for (var h = {}, e = d.createBookmarks(), c = c.createIterator(), g,
                            ...
                            m.evaluator = function(a) {
                                var c = b == CKEDITOR.ENTER_P ? "p" : "div",
                                    d;
                                if (d = (a ? a.type == CKEDITOR.NODE_ELEMENT : !1) && a.getName() in t) { if (c = a.is(c)) c = (c = a.getParent()) ? c.type == CKEDITOR.NODE_ELEMENT : !1;
        ...
        function w(a) {
            ...
            return function(c, h) {
                if (!this.isReadOnly()) {
                    var e;
                    if (e = c == (f || d ?
                            "dir" : "direction") || "style" == c && (d || b.test(h))) { a: { e = this; for (var g = e.getDocument().getBody().getParent(); e;) { if (e.equals(g)) { e = !1; break a } e = e.getParent() } e = !0 } e = !e }
        ...
        CKEDITOR.plugins.add("bidi", {
            init: function(a) {
                ...
                if (!a.blockless) { var d = a.lang.bidi;
            ...
            exec: function(g) {
                ...
                if (c) {
                    ...
                    if (CKEDITOR.env.ie) { var e = h[0].startNode,
                            ...
                            for (d = e; d = d.getNext();)
                                if (d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary()) { e.move(d, !0); break } if (b && "blockquote" == b.getParent().getName())
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (d = {}; a = f.getNextParagraph();) { for (e = c = null; a.getParent();) { if ("blockquote" == a.getParent().getName()) { c = a.getParent();
                                    e = a; break } a = a.getParent() } c && e && !e.getCustomData("blockquote_moveout") && (b.push(e), CKEDITOR.dom.element.setMarker(d, e, "blockquote_moveout", !0)) } CKEDITOR.dom.element.clearAllMarkers(d);
                        a = [];
                        e = [];
                        ...
                        for (b = e.length - 1; 0 <= b; b--) { c = e[b];
                            a: { d = c; for (var f = 0, m = d.getChildCount(), l = void 0; f < m && (l = d.getChild(f)); f++)
                                    if (l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) { d = !1; break a } d = !0 } d && c.remove() }
    ...
    (function() {
        ...
        function y(b) {
            ...
            function c(a) { return { type: a, canUndo: "cut" == a, startDisabled: !0, fakeKeystroke: "cut" == a ? CKEDITOR.CTRL + 88 : CKEDITOR.CTRL + 67, exec: function() { "cut" == this.type && h(); var a; var d = this.type; if (CKEDITOR.env.ie) a = f(d);
                        else try { a = b.document.$.execCommand(d, !1, null) } catch (c) { a = !1 } a || b.showNotification(b.lang.clipboard[this.type + "Error"]); return a } } }
            ...
            (function() {
                function a(d, c, e, f, q) { var g = b.lang.clipboard[c];
                    ...
                    b.addMenuItems && b.addMenuItem(c, { label: g, command: c, group: "clipboard", order: q }) } a("Cut", "cut", c("cut"), 10, 1);
        ...
        function B(b, a) {
            function c(a) { return CKEDITOR.tools.repeat("\x3c/p\x3e\x3cp\x3e", ~~(a / 2)) + (1 == a % 2 ? "\x3cbr\x3e" : "") } a = a.replace(/\s+/g, " ").replace(/> +</g, "\x3e\x3c").replace(/<br ?\/>/gi, "\x3cbr\x3e");
        ...
        function F(b) {
            ...
            b.on("contentDom", function() {
                ...
                f.attachListener(h, "drop", function(d) { if (!d.data.$.defaultPrevented) { d.data.preventDefault(); var c = d.data.getTarget(); if (!c.isReadOnly() || c.type == CKEDITOR.NODE_ELEMENT && c.is("html")) { var c = a.getRangeAtDropPosition(d, b),
                                f = a.dragRange;
        ...
        CKEDITOR.plugins.add("clipboard", {
            ...
            init: function(b) {
                ...
                b.on("paste", function(a) {
                    ...
                    if (!a.data.dataValue) { var c = a.data.dataTransfer,
                            g = c.getData("text/html"); if (g) a.data.dataValue = g, a.data.type = "html";
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            initPasteDataTransfer: function(b, a) {
                if (this.isCustomCopyCutSupported) {
                    if (b &&
                        b.data && b.data.$) { var c = new this.dataTransfer(b.data.$.clipboardData, a);
        ...
        CKEDITOR.plugins.clipboard.dataTransfer =
            function(b, a) {
                ...
                if ("Text" != p) try { this.$.setData(p, this.id) } catch (c) {} a && (this.sourceEditor = a, this.setData("text/html", a.getSelectedHtml(1)), "Text" ==
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            ...
            cacheData: function() {
                function b(b) { b = a._.normalizeType(b); var c = a.getData(b);
                    c && (a._.data[b] = c) }
                if (this.$) {
                    var a = this,
                        c, d;
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                var e = { id: p, button: this, editor: a, focus: function() { CKEDITOR.document.getById(p).focus() }, execute: function() { this.button.click(a) }, attach: function(a) { this.button.attach(a) } },
                    ...
                    w = CKEDITOR.tools.addFunction(function(a) { var b;
    ...
    CKEDITOR.plugins.add("panelbutton", {
        ...
        onLoad: function() {
            function e(c) { var a = this._;
                a.state != CKEDITOR.TRISTATE_DISABLED && (this.createPanel(c), a.on ? a.panel.hide() : a.panel.showBlock(this._.id, this.document.getById(this._.id), 4)) } CKEDITOR.ui.panelButton = CKEDITOR.tools.createClass({
    ...
    (function() {
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function(a, b, c, l) {
                function h() { e.hide() } c.forceIFrame = 1;
        ...
        CKEDITOR.on("instanceDestroyed", function() {
            ...
            for (b in f) { var c = f[b];
                a ? c.destroy() : c.element.hide() } a && (f = {})
        })
    })();
    CKEDITOR.plugins.add("colorbutton", {
        ...
        init: function(d) {
            function r(a, c, e, g, k) {
                ...
                d.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    onBlock: function(a,
                        ...
                        CKEDITOR.ui.fire("ready", this); var f = b.keys,
                            e = "rtl" == d.lang.dir;
                        f[e ? 37 : 39] = "next";
                        f[40] = "next";
                        f[9] = "next";
                    ...
                    p = CKEDITOR.tools.addFunction(function(b,
                        ...
                        if ("?" == b) d.openDialog("colordialog", function() { this.on("ok", e);
                            ...
                            if (b) {
                                ...
                                g.childRule = "back" == c ? function(a) { return t(a) } : function(a) {
                                    return !(a.is("a") ||
            ...
            function t(a) { return "false" == a.getAttribute("contentEditable") || a.getAttribute("data-nostyle") }
            var l = d.config,
            ...
            if (!CKEDITOR.env.hc) {
                ...
                if (void 0 === v || v) u.contentTransformations = [
                    [{
                        element: "span",
                        left: function(a) { var c = CKEDITOR.tools; if ("span" != a.name || !a.styles || !a.styles.background) return !1;
                            a = c.style.parse.background(a.styles.background); return a.color && 1 === c.objectKeys(a).length },
                        right: function(a) {
            ...
            proto: {
                ...
                show: function(a, b, d, m) {
                    ...
                    for (var c = k.elementPath(), c = ['\x3cdiv class\x3d"cke_menu' + (c && c.direction() != k.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], h = g.length, n = h && g[0].group,
                        ...
                        p.render(this, q, c) } c.push("\x3c/div\x3e");
                    f.setHtml(c.join(""));
                    CKEDITOR.ui.fire("ready", this);
    ...
    (function() {
        function q(a) { var b = (a = a.data) && a.$; return a && b ? CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? 1 === b.button : 0 === b.button : !1 }

        function k(a, b, e, d) { var c = new CKEDITOR.dom.walker(a); if (a = a.startContainer.getAscendant(b, !0) || a.endContainer.getAscendant(b, !0))
                if (e(a), d) return; for (; a = c.next();)
                if (a = a.getAscendant(b, !0))
                    if (e(a), d) break }

        function t(a, b) { var e = { ul: "ol", ol: "ul" }; return -1 !== m(b, function(b) { return b.element === a || b.element === e[a] }) }
        ...
        CKEDITOR.plugins.add("copyformatting", {
            ...
            init: function(a) {
                ...
                a.on("contentDom", function() {
                    ...
                    e.attachListener(CKEDITOR.document, "mouseup", function(b) { var d = a.getCommand("copyFormatting");
                ...
                a.on("key", function(b) { var d = a.getCommand("copyFormatting");
                    b = b.data.domEvent;
                ...
                a.copyFormatting.on("applyFormatting", function(b) { var d = CKEDITOR.plugins.copyformatting,
        ...
        l.prototype._isContextAllowed = function(a) { var b = this.editor.config.copyFormatting_allowedContexts; return !0 === b || -1 !== m(b, a) };
        ...
        CKEDITOR.plugins.copyformatting = {
            ...
            _convertElementToStyleDef: function(a) { var b = CKEDITOR.tools,
                    e = a.getAttributes(CKEDITOR.plugins.copyformatting.excludedAttributes),
                    b = b.parseCssText(a.getAttribute("style"), !0, !0); return { element: a.getName(), type: CKEDITOR.STYLE_INLINE, attributes: e, styles: b } },
            ...
            _getSelectedWordOffset: function(a) {
                function b(a, b) { return a[b ? "getPrevious" : "getNext"](function(a) { return a.type !== CKEDITOR.NODE_COMMENT }) }

                function e(a) { return a.type == CKEDITOR.NODE_ELEMENT ? (a = a.getHtml().replace(/<span.*?>&nbsp;<\/span>/g, ""), a.replace(/<.*?>/g, "")) : a.getText() }
                ...
                function d(a, c) {
                    var f = a,
                        ...
                        l = !1,
                        p, n;
                    do { for (p = b(f, c); !p && f.getParent();) { f = f.getParent(); if (-1 !== m(h, f.getName())) { l = k = !0; break } p = b(f, c) } if (p && p.getName && -1 !== m(h, p.getName())) { k = !0; break } f = p } while (f && f.getStyle && ("none" == f.getStyle("display") || !f.getText()));
            ...
            _determineContext: function(a) {
                function b(b) { var d = new CKEDITOR.dom.walker(a),
                        c; if (a.startContainer.getAscendant(b, !0) || a.endContainer.getAscendant(b, !0)) return !0; for (; c = d.next();)
                        if (c.getAscendant(b, !0)) return !0 } return b({ ul: 1, ol: 1 }) ? "list" : b("table") ? "table" : "text" },
            _applyStylesToTextContext: function(a, b, e) {
                ...
                for (g = 0; g < e.length; g++)
                    if (b = e[g], -1 === m(d.excludedElementsFromInlineTransform, b.element)) { if (-1 !== m(d.elementsForInlineTransform, b.element))
            ...
            _applyStylesToListContext: function(a, b, e) {
                ...
                for (g = 0; g < e.length; g++) d = e[g], c = b.createBookmark(), "ol" === d.element || "ul" === d.element ?
                    k(b, { ul: 1, ol: 1 }, function(a) { var b = d;
    ...
    (function() {
        function D(a) {
            function d() { for (var b = g(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || v(a), f = 0; f < e.length; f++) { var m = e[f]; if ("/" != m) { "string" == typeof m && (m = e[f] = { name: m }); var l, d = m.groups; if (d)
                            for (var h = 0; h < d.length; h++) l = d[h], (l = b[l]) && c(m, l);
                        (l = b[m.name]) && c(m, l) } } return e }
        ...
        function q(a, e) {
            ...
            var v = CKEDITOR.tools.addFunction(l),
                w = CKEDITOR.tools.addFunction(function(c, d) {
                    ...
                    switch (d.getKeystroke()) {
                        case b ?
                        39:
                            37: case 9: return (b = CKEDITOR.document.getById(g + (c + 1))) || (b = CKEDITOR.document.getById(g + "0")), b.focus(), !1;
                        case b ? 37:
            ...
            a.on("selectionChange", function() {
                for (var c = [], d = k.list = [], g = [], b = k.filters, e = !0, l = a.elementPath().elements, f, u = l.length; u--;) {
                    ...
                    for (var t = 0; t < b.length; t++) { var m = b[t](h, f); if (!1 === m) { r = 1; break } f = m || f } r || (d.unshift(h), g.unshift(f))
                }
                d = d.length;
        ...
        function k(b, f) { var g = {},
            ...
            b = b.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g, function(b, a) { var d = f ? "\x26" + a + ";" : e[a];
                ...
                a = null; for (a = 0; a < d.length; a++) { var h = d.charAt(a);
                    g[h] = "\x26" + b[a] + ";";
                    c.push(h) } } g.regex = c.join(f ? "|" : ""); return g } CKEDITOR.plugins.add("entities", {
    ...
    (function() {
        ...
        function h(a, c, d) { if (-1 !== d.indexOf(";")) { d = d.split(";"); for (var b = 0; b < d.length; b++)
                    if (h(a, c, d[b])) return !0; return !1 } return (a = a.getContents(c).get(d).filebrowser) && a.url }
            ...
            b && d.getContentElement(b[0], b[1]).reset(); if ("function" != typeof c || !1 !== c.call(this._.filebrowserSe))
                if (!e || !1 !== e.call(this._.filebrowserSe, a, c))
                    if ("string" == typeof c && c && alert(c), a && (b = this._.filebrowserSe, d = b.getDialog(), b = b.filebrowser.target || null))
                        if (b = b.split(":"), e = d.getContentElement(b[0], b[1])) e.setValue(a), d.selectPage(b[0]) } CKEDITOR.plugins.add("filebrowser", {
            requires: "popup",
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("flash", {
            ...
            afterInit: function(a) { var b = a.dataProcessor;
                (b = b && b.dataFilter) && b.addRules({ elements: { "cke:object": function(b) { var c = b.attributes; if (!(c.classid && String(c.classid).toLowerCase() || d(b))) { for (c = 0; c < b.children.length; c++)
                                    if ("cke:embed" == b.children[c].name) { if (!d(b.children[c])) break; return e(a, b) } return null } return e(a, b) }, "cke:embed": function(b) { return d(b) ? e(a, b) : null } } }, 5) }
        })
    })();
                ...
                proto: {
                    ...
                    unmarkAll: function() {
                        ...
                        for (c in a) { var d = a[c];
                            ...
                            b.getById(d + "_option").removeAttribute("aria-selected") } this.onUnmark &&
                            this.onUnmark()
                    },
    ...
    (function() {
        function n(a, c, k, d, q, n, u, w) {
            var x = a.config,
                ...
                f = q.split(";");
            q = [];
            for (var m = {}, g = 0; g < f.length; g++) { var l = f[g]; if (l) { var l = l.split("/"),
                        v = {},
                        p = f[g] = l[0];
                    v[k] = q[g] = l[1] || p;
                    m[p] = new CKEDITOR.style(u, v);
                    m[p]._.definition.name = p } else f.splice(g--, 1) } a.ui.addRichCombo(c, {
                label: d.label,
                title: d.panelTitle,
                toolbar: "styles," + w,
                allowedContent: r,
                ...
                contentTransformations: [
                    [{
                        ...
                        right: function(b) { var a = " x-small small medium large x-large xx-large 48px".split(" ");
                            b.name = "span";
                ...
                init: function() { this.startGroup(d.panelTitle); for (var b = 0; b < f.length; b++) { var a = f[b];
                ...
                onClick: function(b) {
                    ...
                    if (c && b != c) {
                        ...
                        if (e.collapsed) {
                            var f = a.elementPath(),
                                h = f.contains(function(a) { return d.checkElementRemovable(a) });
                            if (h) {
        ...
        function t(a, c, k) { var d = c.pop(); if (d) { if (k) return t(a, c, d.equals(k) ? null : k);
                k = d.clone();
                a.insertNode(k);
                a.moveToPosition(k, CKEDITOR.POSITION_AFTER_START);
                t(a, c) } } CKEDITOR.plugins.add("font", {
            requires: "richcombo",
            init: function(a) {
                var c = a.config;
    ...
    CKEDITOR.plugins.add("forms", {
        ...
        init: function(a) {
            var b = a.lang,
                ...
                e = function(d, c, e) { var h = { allowedContent: l[c], requiredContent: m[c] }; "form" == c && (h.context = "form");
            ...
            a.contextMenu && (!a.blockless && a.contextMenu.addListener(function(d, c, a) { if ((d = a.contains("form", 1)) && !d.isReadOnly()) return { form: CKEDITOR.TRISTATE_OFF } }), a.contextMenu.addListener(function(d) {
                if (d && !d.isReadOnly()) {
                    var c = d.getName();
            ...
            a.on("doubleclick", function(d) {
                ...
                if (!a.blockless && c.is("form")) d.data.dialog = "form";
                    ...
                    "textarea";
                        ...
                        case "submit":
                        case "reset":
                            d.data.dialog = "button"; break;
                        case "checkbox":
                            d.data.dialog = "checkbox"; break;
                        case "radio":
                            d.data.dialog = "radio"; break;
                        case "image":
                            d.data.dialog = "imagebutton" } h[c] && (d.data.dialog = "textfield") }
            })
        },
        afterInit: function(a) {
            var b = a.dataProcessor,
                ...
                b = b && b.dataFilter;
            CKEDITOR.env.ie &&
                g && g.addRules({ elements: { input: function(a) { a = a.attributes; var b = a.type;
        ...
        init: function(a) {
            if (!a.blockless) {
                for (var f = a.config, c = a.lang.format, l = f.format_tags.split(";"), d = {}, m = 0, n = [], g = 0; g < l.length; g++) { var h = l[g],
                        k = new CKEDITOR.style(f["format_" + h]); if (!a.filter.customConfig || a.filter.check(k)) m++, d[h] = k, d[h]._.enterMode = a.config.enterMode, n.push(k) } 0 !== m && a.ui.addRichCombo("Format", {
                    label: c.label,
                    title: c.panelTitle,
                    toolbar: "styles,20",
                    allowedContent: n,
            ...
            init: function(a) {
                ...
                a.addMode("wysiwyg", function(f) {
                    ...
                    if (h) { var g = CKEDITOR.tools.getNextId(),
                        ...
                        c.append(k, 1);
                        d.setAttribute("aria-describedby", g) } a.on("beforeModeUnload", function(a) { a.removeListener();
                        k && k.remove() });
    ...
    (function() {
        ...
        function f(b) { var a = b.getStyle("float"); if ("inherit" == a || "none" == a) a = 0;
            a || (a = b.getAttribute("align")); return a } CKEDITOR.plugins.add("image", {
            requires: "dialog",
            init: function(b) {
                if (!b.plugins.image2) {
    ...
    (function() {
        function f(b, c, a) {
            if (!b.getCustomData("indent_processed")) {
                ...
                if (c) { d = b.$.className.match(this.classNameRegex);
                    a = 0;
                    d && (d = d[1], a = CKEDITOR.tools.indexOf(c, d) + 1); if (0 > (a += l ? 1 : -1)) return;
        ...
        function m(b, c) { return "ltr" == (c || b.getComputedStyle("direction")) ? "margin-left" : "margin-right" }
                    ...
                    this.jobs = {
                        20: {
                            refresh: function(a, b) {
                                ...
                                if (this.enterBr || this.getContext(b)) {
                                    if (d) { var c = d,
                                            ...
                                            f = this.isIndent,
                                            c = e ? f ? e[1] != c.slice(-1) : !0 : f; return c ? n : k }
                            ...
                            exec: function(a) { var b = a.getSelection(),
                                    b = b && b.getRanges()[0],
                                    c; if (c = a.elementPath().contains(p)) f.call(this, c, d);
                                else
                                    for (b = b.createIterator(), a = a.config.enterMode, b.enforceRealBlocks = !0, b.enlargeBr = a != CKEDITOR.ENTER_BR; c = b.getNextParagraph(a == CKEDITOR.ENTER_P ? "p" : "div");) c.isReadOnly() || f.call(this, c, d); return !0 }
                        }
                    }
                }
        ...
        function w(c) {
            function f(b) {
                ...
                for (a = 0; a < g.length; a++)
                    if (g[a].getName && p[g[a].getName()]) { b = g[a]; break } for (var g = l.isIndent ? 1 : -1, a = e[0], e = e[e.length - 1], k = CKEDITOR.plugins.list.listToArray(b, q), n = k[e.getCustomData("listarray_index")].indent,
                        a = a.getCustomData("listarray_index"); a <= e.getCustomData("listarray_index"); a++)
                    if (k[a].indent += g, 0 < g) { var h = k[a].parent;
                        k[a].parent = new CKEDITOR.dom.element(h.getName(), h.getDocument()) } for (a = e.getCustomData("listarray_index") + 1; a < k.length && k[a].indent > n; a++) k[a].indent += g;
                ...
                if (r && r.length)
                    for (a = 0; a < r.length; a++) { for (m = b = r[a];
                        ...
                        b.insertAfter(f) } e && c.fire("contentDomInvalidated");
                return !0
            }
            for (var l = this, q = this.database, p = this.context, n = c.getSelection(), n = (n && n.getRanges()).createIterator(), d; d = n.getNextRange();) {
                ...
                if (!b) { var h = d.getEnclosedNode();
                    h && h.type == CKEDITOR.NODE_ELEMENT && h.getName() in p && (d.setStartAt(h, CKEDITOR.POSITION_AFTER_START), d.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), b = h) } b && d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in p && (h = new CKEDITOR.dom.walker(d), h.evaluator = t, d.startContainer = h.next());
    ...
    (function() {
        function n(a, c) { c = void 0 === c || c; var b; if (c) b = a.getComputedStyle("text-align");
            else { for (; !a.hasAttribute || !a.hasAttribute("align") && !a.getStyle("text-align");) { b = a.getParent(); if (!b) break;
                    a = b } b = a.getStyle("text-align") || a.getAttribute("align") || "" } b && (b = b.replace(/(?:-(?:moz|webkit)-)?(?:start|auto)/i, ""));!b && c && (b = "rtl" == a.getComputedStyle("direction") ? "right" : "left"); return b }
        ...
        function g(a, c, b) {
            ...
            if (c) { switch (b) {
                    ...
                    case "justify":
                        this.cssClassName = c[3] } this.cssClassRegex = new RegExp("(?:^|\\s+)(?:" + c.join("|") + ")(?\x3d$|\\s)");
        ...
        CKEDITOR.plugins.add("language", {
            ...
            init: function(a) {
                ...
                a.addCommand("language", {
                    ...
                    contextSensitive: !0,
                    exec: function(a, b) { var c = e["language_" + b]; if (c) a[c.style.checkActive(a.elementPath(), a) ? "removeStyle" : "applyStyle"](c.style) },
                    refresh: function(a) {
            ...
            getCurrentLangElement: function(a) { var b = a.elementPath();
                a = b && b.elements; var c; if (b)
                    for (var d = 0; d < a.length; d++) b = a[d], !c && "span" == b.getName() && b.hasAttribute("dir") && b.hasAttribute("lang") && (c = b); return c }
        })
    })();
    (function() {
    ...
    (function() {
        function I(b, m, e) {
            ...
            for (k = h + 1; k < f.length; k++)
                if (f[k].indent > f[k - 1].indent + 1) { g = f[k - 1].indent + 1 - f[k].indent; for (h = f[k].indent; f[k] && f[k].indent >= h;) f[k].indent += g, k++;
                    k-- } var d = CKEDITOR.plugins.list.arrayToList(f, e, null, b.config.enterMode, m.root.getAttribute("dir")).listNode,
                a, p;
            c(!0);
            c();
            d.replace(m.root);
        ...
        function F(b) {
            function m(e) { var c = b[e ? "getPrevious" : "getNext"](u);
                c && c.type == CKEDITOR.NODE_ELEMENT && c.is(b.getName()) && (E(b, c, null, !e), b.remove(), b = c) } m();
            m(1) }
                        ...
                        if (!d.getCustomData("list_block")) {
                            ...
                            for (var l = b.elementPath(d), a = l.elements, p = 0, l = l.blockLimit, q, n = a.length - 1; 0 <= n && (q = a[n]); n--)
                                if (v[q.getName()] && l.contains(q)) { l.removeCustomData("list_group_object_" + h);
                                    ...
                                    p = 1; break } p || (p = l, p.getCustomData("list_group_object_" +
                    ...
                    if (a = f.shift(), this.state == CKEDITOR.TRISTATE_OFF)
                        if (v[a.root.getName()]) {
                            ...
                            for (var n = h.root.getDocument(), t = void 0, r = void 0, d = 0; d < l.length; d++) { var y = l[d].getCustomData("listarray_index"),
                                    t = p[y].parent;
                                t.is(this.type) || (r = n.createElement(this.type), t.copyAttributes(r, { start: 1, type: 1 }), r.removeStyle("list-style-type"), p[y].parent = r) } a = CKEDITOR.plugins.list.arrayToList(p, a, null, c.config.enterMode);
                            p = void 0;
                            ...
                            for (n = 0; n < l.length; n++)
                                for (r = l[n]; y = r.getParent();) { if (y.equals(g)) { h.push(r);!p && r.getDirection() && (p = 1);
                                        r = r.getDirection(t);
                                        null !== a && (a = a && a != r ? null : r); break } r = y }
                            if (!(1 > h.length)) {
                                l =
                                ...
                                if (k) {
                                    ...
                                    if (d.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), k = (h = c.getLast(u)) &&
                                        ...
                                        if (1 == g && (e.optimize(), !e.startContainer.equals(c))) { for (c = e.startContainer; c.is(CKEDITOR.dtd.$inline);) p = c, c = c.getParent();
                                            p && e.moveToPosition(p, CKEDITOR.POSITION_AFTER_END) } 2 == g && (e.moveToPosition(e.endPath().block, CKEDITOR.POSITION_BEFORE_END), f.endPath().block && f.moveToPosition(f.endPath().block, CKEDITOR.POSITION_AFTER_START));
                                        C(b, e, f);
                                        m.cancel()
                                    }
            ...
            init: function(a) {
                if (!a.blockless) {
                    ...
                    a.contextMenu.addListener(function(a) {
                        ...
                        for (; a;) { var b = a.getName(); if ("ol" == b) return { numberedlist: CKEDITOR.TRISTATE_OFF }; if ("ul" == b) return { bulletedlist: CKEDITOR.TRISTATE_OFF };
                            a = a.getParent() }
                        return null
                    })
                }
    ...
    (function() {
        ...
        function aa(a, c) { if (!c) return !1; for (var d = c.getParents(1), b = d.length; b--;)
                for (var e = a.tabuList.length; e--;)
                    if (d[b].hasAttribute(a.tabuList[e])) return !0; return !1 }
    ...
    (function() {
        function e(a) { return { "aria-label": a, "class": "cke_pagebreak", contenteditable: "false", "data-cke-display-name": "pagebreak", "data-cke-pagebreak": 1, style: "page-break-after: always", title: a } } CKEDITOR.plugins.add("pagebreak", {
            ...
            afterInit: function(a) {
                ...
                c && c.addRules({ attributes: { "class": function(a, b) { var c = a.replace("cke_pagebreak", ""); if (c != a) { var d = CKEDITOR.htmlParser.fragment.fromHtml('\x3cspan style\x3d"display: none;"\x3e\x26nbsp;\x3c/span\x3e').children[0];
                                b.children.length = 0;
                                b.add(d);
                                d = b.attributes;
                                delete d["aria-label"];
                                delete d.contenteditable;
                                delete d.title } return c } } }, {
                    applyToAll: !0,
                    priority: 5
                });
        ...
        CKEDITOR.plugins.pagebreakCmd = {
            exec: function(a) { var b = a.document.createElement("div", { attributes: e(a.lang.pagebreak.alt) });
                a.insertElement(b) },
            context: "div",
            allowedContent: {
    ...
    (function() {
        function l(a, b, f) { var d = CKEDITOR.cleanWord;
            d ? f() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || b + "filter/default.js"), CKEDITOR.scriptLoader.load(a, f, null, !0)); return !d }

        function g(a) { a.data.type = "html" } CKEDITOR.plugins.add("pastefromword", {
            requires: "clipboard",
            init: function(a) {
                var b = 0,
                    f = this.path;
                ...
                a.on("paste", function(d) {
                    var c = d.data,
                        ...
                        e = { dataValue: h };
                    if (h && (b || g.test(h)) && (!1 !== a.fire("pasteFromWord", e) || b)) { c.dontFilter = !0; var k = l(a, f, function() { if (k) a.fire("paste", c);
    ...
    (function() {
        var k = { readOnly: 1, preserveState: !0, editorFocus: !1, exec: function(a) { this.toggleState();
                this.refresh(a) }, refresh: function(a) { if (a.document) { var c = this.state != CKEDITOR.TRISTATE_ON || a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE && !a.focusManager.hasFocus ? "removeClass" : "attachClass";
        ...
        CKEDITOR.plugins.add("showblocks", {
            ...
            init: function(a) {
                ...
                if (!a.blockless) { var b = a.addCommand("showblocks", k);
                    b.canUndo = !1;
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        init: function(a) {
            ...
            a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function(b, d) { var h = a.scayt,
                    k, e;
                h && (e = h.getSelectionNode()) && (k = c.menuGenerator(a, e), h.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" ."))); return k }), a.contextMenu._.onHide = CKEDITOR.tools.override(a.contextMenu._.onHide, function(b) { return function() { var d = a.scayt;
        ...
        bindEvents: function(a) {
            var c = CKEDITOR.plugins.scayt,
                ...
                f = function() {
                    ...
                    b.attachListener(b, "focus", function(b) { CKEDITOR.plugins.scayt && !a.scayt && setTimeout(e, 0);
                        b = CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[a.name] && a.scayt; var c, h; if ((d || b) && a._.savedSelection) { b = a._.savedSelection.getSelectedElement();
                            b = !b && a._.savedSelection.getRanges(); for (var f = 0; f < b.length; f++) h = b[f], "string" === typeof h.startContainer.$.nodeValue && (c = h.startContainer.getText().length, (c < h.startOffset || c < h.endOffset) && a.unlockSelection(!1)) } }, this, null, -10)
                },
                g = function() {
                    d ?
                    ...
                    f();
                    var c = a.editable();
                    c.attachListener(c, "mousedown", function(b) { b = b.data.getTarget(); var d = a.widgets && a.widgets.getByElement(b);
            ...
            a.on("reloadMarkupScayt", function(b) { var d = b.data && b.data.removeOptions;
                b = b.data && b.data.timeout; var e = a.scayt;
        ...
        parseConfig: function(a) {
            ...
            if ("string" ===
                typeof a.config.scayt_uiTabs && 3 === a.config.scayt_uiTabs.split(",").length) { var d = [],
                    b = [];
    ...
    CKEDITOR.plugins.scayt = {
        ...
        createScayt: function(a) {
            ...
            this.loadScaytLibrary(a, function(a) {
                ...
                if (f) {
                    ...
                    var g;
                    try { g = e(f) } catch (h) { c.alarmCompatibilityMessage(), delete f.charsToObserve, g = e(f) } g.subscribe("suggestionListSend", function(a) { for (var b = {}, d = [], c = 0; c < a.suggestionList.length; c++) b["word_" + a.suggestionList[c]] || (b["word_" + a.suggestionList[c]] = a.suggestionList[c], d.push(a.suggestionList[c]));
                    ...
                    g.addMarkupHandler && g.addMarkupHandler(function(c) { var d = a.editable(),
        ...
        loadScaytLibrary: function(a,
            c) { var d, b = function() { CKEDITOR.fireOnce("scaytReady");
                ...
                c.ui.addRichCombo("Styles", {
                    ...
                    onRender: function() { c.on("selectionChange", function(b) { var a = this.getValue();
                            b = b.data.path.elements; for (var h = 0, d = b.length, e; h < d; h++) { e = b[h]; for (var g in f)
                                    if (f[g].checkElementRemovable(e, !0, c)) { g != a && this.setValue(g); return } } this.setValue("") }, this) },
                    onOpen: function() {
                        var b =
                        ...
                        for (var h in f) { var d = f[h],
                            ...
                            d.checkActive(b, c) && this.mark(h) } a[CKEDITOR.STYLE_BLOCK] || this.hideGroup(g["panelTitle" + String(CKEDITOR.STYLE_BLOCK)]);
    ...
    CKEDITOR.dom.element.prototype.focusNext = function(k, h) {
        var g = void 0 === h ? this.getTabIndex() : h,
            f, c, d, e, b, a;
        if (0 >= g)
            for (b = this.getNextSourceNode(k, CKEDITOR.NODE_ELEMENT); b;) { if (b.isVisible() && 0 === b.getTabIndex()) { d = b; break } b = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT) } else
                for (b = this.getDocument().getBody().getFirst(); b = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
                    if (!f)
                        if (!c && b.equals(this)) { if (c = !0, k) { if (!(b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT))) break;
                            ...
                            (f = 1);
                    if (b.isVisible() && !(0 > (a = b.getTabIndex()))) { if (f && a == g) { d = b; break } a > g && (!d || !e || a < e) ? (d = b, e = a) : d || 0 !== a || (d = b, e = a) }
                }
        d && d.focus()
    };
    CKEDITOR.dom.element.prototype.focusPrevious = function(k, h) { for (var g = void 0 === h ? this.getTabIndex() : h, f, c, d, e = 0, b, a = this.getDocument().getBody().getLast(); a = a.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT);) { if (!f)
                if (!c && a.equals(this)) { if (c = !0, k) { if (!(a = a.getPreviousSourceNode(!0, CKEDITOR.NODE_ELEMENT))) break;
                        f = 1 } } else c && !this.contains(a) && (f = 1); if (a.isVisible() && !(0 > (b = a.getTabIndex())))
                if (0 >= g) { if (f && 0 === b) { d = a; break } b > e && (d = a, e = b) } else { if (f && b == g) { d = a; break } b < g && (!d || b > e) && (d = a, e = b) } } d && d.focus() };
    ...
    (function() {
        function t(e) {
            function d(a) { 0 < b.length || a.type != CKEDITOR.NODE_ELEMENT || !C.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(c, a, "selected_cell", !0), b.push(a)) } e = e.getRanges();
        ...
        function p(e, d) {
            for (var b = t(e), c = b[0], a = c.getAscendant("table"), c = c.getDocument(), f = b[0].getParent(), g = f.$.rowIndex, b = b[b.length - 1], h = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(a.$.rows[h]), g = d ? g : h, f = d ? f : b, b = CKEDITOR.tools.buildTableMap(a), a = b[g], g = d ? b[g - 1] : b[g + 1], b = b[0].length, c = c.createElement("tr"),
                ...
                h += k.colSpan - 1 } d ? c.insertBefore(f) : c.insertAfter(f)
        }
        ...
        function v(e, d) { for (var b = d ? Infinity : 0, c = 0; c < e.length; c++) { var a;
                a = e[c]; for (var f = d, g = a.getParent().$.cells, h = 0, k = 0; k < g.length; k++) { var l = g[k],
                        h = h + (f ? 1 : l.colSpan); if (l == a.$) break } a = h - 1; if (d ? a < b : a > b) b = a } return b }
                ...
                a: {
                    ...
                    for (c = 0; f = e[c++];)
                        if ((g = f.getPrevious()) && !g.getCustomData("delete_cell") || (g = f.getNext()) && !g.getCustomData("delete_cell")) { CKEDITOR.dom.element.clearAllMarkers(a);
                            b = g; break a } CKEDITOR.dom.element.clearAllMarkers(a);g = e[0].getParent();
        ...
        function w(e, d, b) {
            ...
            if (d) { var r; try { var q = parseInt(e.getAttribute("rowspan"), 10) || 1;
                ...
                c["up" == d || "left" == d ? "unshift" : "push"](new CKEDITOR.dom.element(r)) } d = e.getDocument();
            var p = l,
                q = r = 0,
        ...
        function B(e, d) {
            ...
            if (1 < g) c = Math.ceil(g / 2), g = Math.floor(g / 2);
                    ...
                    h.push(l[f]);
                    1 < l[f].rowSpan && (k += l[f].rowSpan - 1) } for (a = 0; a < h.length; a++) h[a].colSpan++ } a = b.clone();
            a.insertAfter(b);
            a.appendBogus();
            b.$.colSpan = c;
            a.$.colSpan = g;
