<?php
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('admin/administrator/pelatihan_bab_edit',$attributes);
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><input type='file' class='form-control' name='gambar'><hr style='margin:5px'>";
                        if ($rows['gambar'] != ''){ echo "<i style='color:red'>Foto Saat ini : </i><a target='_BLANK' href='".base_url()."theme/images/foto_pelatihan/pelatihan_detail/$rows[gambar]'>$rows[gambar]</a>"; } echo "</td></tr>
                      </td>
                    </tr>
                    <tr>
