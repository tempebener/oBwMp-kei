<div class="col-md-12">
              ...
              <div class="col-md-12">
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>File PDF</th>                 <td><input type='file' class='form-control' name='k' required></td></tr>
                   <tr> <th scope='row'><td>NOTED: Nama File PDF Tidak boleh mengunakan Spasi. </td></th></tr>

                    <tr><th width="120px" scope="row">LINK Video Youtube</th>    <td><input type="text" class="form-control" name="b" required></td></tr>
                  </tbody>
                  </table>
                </div>
