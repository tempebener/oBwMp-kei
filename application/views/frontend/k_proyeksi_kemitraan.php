...
<!-- head -->
 <head>
    <title>PROYEKSI KEMITRAAN TAHUN 2020</title>
    ...
    <!-- head end -->
        ...
        <div class="container">
          ...
          <div class="breadcrumb">
            <div class="breadcrumb-inner">
              ...
              <div class="breadcrumb-item"><span class="breadcrumb-text">Proyeksi Kemitraan</span></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Deskripsi Profil -->
       <section class="section-md bg-transparent text-center">
        <div class="container">
            <h2>PROYEKSI KEMITRAAN TAHUN 2020</h2>
          ...
          <div class="row row-30">
            <div class="col-md-6 col-xl-12 d-flex">
              <img class="image-custom rounded" src="<?php echo base_url();?>theme/images/skema_kemitraan/proyeksi_kemitraan.png" alt="PROYEKSI KEMITRAAN TAHUN 2020" width="100%" height="auto">
            </div>
