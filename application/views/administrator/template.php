...
<html>
  <head>
    ...
    <title>Selamat Datang Di Website KEI</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/chosen/chosen.min.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/cdnjs/select2.min.css" />
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <?php $row = $this->model_app->view_one_address('wmu_conf_perusahaan',array('id_perusahaan' => 1),'id_perusahaan')->row_array(); ?>
    <div class="wrapper">
    ...
    <img class='pull-left' style='width:70px; height:60px;margin-right:10px; border:1px solid #' src='<?php echo base_url()."asset/images/$row[logo]"; ?>'>
      <h3 style='margin:0px;'><b><?php echo $row['nama_perusahaan'] ?></b></h3>
      <p style='color:#000'><?php echo "$row[alamat_perusahaan] $row[kode_pos]. $row[telepon]"; ?></p>
    </div>
    ...
    <script src="<?php echo base_url(); ?>asset/chosen/chosen.jQuery.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/cdnjs/select2.full.min.js"></script>
